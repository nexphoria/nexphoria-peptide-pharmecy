...
export const article: BlogArticle = {
  slug: "hplc-purity-testing-research-peptides-guide-jun21-2026",
  title: "Why HPLC Purity Testing Matters When Sourcing Peptides",
  description:
    "HPLC purity testing is the gold standard for research peptides — what the method measures, why ≥99% purity matters for experimental validity, and how it complements mass spectrometry and LAL endotoxin testing.",
