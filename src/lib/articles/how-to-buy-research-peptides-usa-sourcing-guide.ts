...
export const article: BlogArticle = {
  slug: "how-to-buy-research-peptides-usa-sourcing-guide",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A Certificate of Analysis (COA) is the primary documentation artifact accompanying a research peptide. A comprehensive COA should include: peptide identity confirmed by mass spectrometry (not just name), HPLC purity with accompanying chromatogram, molecular weight (observed vs. theoretical with method specified), appearance description, solubility confirmed in appropriate solvent, endotoxin level (LAL test result in EU/mg or EU/mL), lot/batch number traceable to your specific shipment, and testing date (recency matters; peptides degrade; old COAs may not reflect current lot).",
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "Peptides are temperature-sensitive. Improper shipping conditions are one of the most common causes of reduced potency in received peptides — and one of the least visible. Lyophilized peptides are stable at room temperature for days, but best stored at -20°C for long-term use. Reconstituted peptides should be stored at 4°C and used within 28–30 days, avoiding repeated freeze-thaw. Extended research stocks held longer than 6 months benefit from -80°C storage.",
    },
    {
      type: "paragraph",
      text: "For shipping: ice packs (4°C) are acceptable for lyophilized peptides during transit of 2–3 days; dry ice is required for extended transit or reconstituted peptide shipments. Summer shipping in uninsulated packaging represents a serious quality risk. Ask suppliers directly how they ship during warm months — a supplier without a seasonal cold-chain protocol is not a research-grade supplier.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "A research-grade supplier should synthesize peptides to ≥99% HPLC purity verified by reverse-phase chromatography, confirm identity by ESI mass spectrometry, test for endotoxins via LAL assay with results on every COA, ship via validated cold-chain protocols with temperature-controlled packaging, and provide third-party verified COAs accessible by lot number without requiring a purchase. If a supplier makes you ask twice for documentation, that tells you something about their standards.",
    },
    {
      type: "heading",
      text: "Summary",
