...
export const article: BlogArticle = {
  slug: "muscle-recovery-peptides-bpc157-tb500-igf1-2026",
  title: "5 Research Peptides Used in Muscle Recovery Studies (2026)",
  description:
    "BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin have all been examined in muscle recovery and regeneration studies. This article summarizes the preclinical evidence and mechanisms for each.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "BPC-157 is thought to act via nitric oxide modulation and FAK-paxillin signaling, enhancing cell migration and angiogenesis critical to repair. Key references include multiple publications from Sikiric et al. at the University of Zagreb and the Gwyer et al. systematic review (2019).",
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      rows: [
        ["BPC-157", "Multi-system", "NO/VEGF/FAK signaling", "Rat crush injury"],
        ...
        ["Ipamorelin", "GHSR-1a", "GH pulse induction", "Rodent"],
      ],
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "All five peptides require rigorous quality verification to ensure experimental integrity. Researchers should prioritize suppliers providing HPLC purity ≥98%, mass spectrometry identity confirmation, endotoxin-free certification via LAL testing, and proper cold-chain shipping and storage.",
    },
    {
      type: "heading",
      text: "Summary",
