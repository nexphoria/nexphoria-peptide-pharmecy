...
export const article: BlogArticle = {
  slug: "peptide-reconstitution-complete-protocol-2026",
  title: "How to Reconstitute Peptides: Complete Protocol Guide (2026)",
  description:
    "Step-by-step research protocol for reconstituting lyophilized peptides in 2026. Covers bacteriostatic water selection, dilution math, aseptic technique, concentration reference tables, and post-reconstitution storage best practices.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Determine the concentration needed for your research protocol before adding any liquid. The standard formula: Concentration (mcg/mL) = Peptide mass (mcg) ÷ Volume of diluent (mL). Example: For a 5 mg (5,000 mcg) vial targeting 2 mg/mL, diluent needed = 5,000 ÷ 2,000 = 2.5 mL.",
    },
    {
      type: "subheading",
