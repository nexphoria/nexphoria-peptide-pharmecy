...
export const article: BlogArticle = {
  slug: "selank-anxiety-research-jun23-2026",
  title: "Selank: The Russian Peptide Studied for Anxiety",
  description:
    "An evidence-based overview of Selank, the heptapeptide developed in Russia and studied for anxiolytic and nootropic effects. Research findings, mechanism of action, and what the data actually shows.",
  ...
  body: [
    {
      type: "callout",
      text: "All compounds discussed in this article are sold for qualified research use only. This article covers pre-clinical and observational data and is not a guide to human therapeutic use.",
    },
    {
      type: "paragraph",
    ...
    },
    {
      ...
      rows: [
        ["Selank", "GABAergic modulation, BDNF, enkephalin stabilization", "Russia (approved)", "Moderate — primarily Russian literature"],
