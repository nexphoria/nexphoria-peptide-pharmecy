...
export const article: BlogArticle = {
  slug: "hexarelin-cardioprotection-research-guide-jun21-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "GH-deficient patients and animal models consistently show impaired cardiac function — reduced cardiac output, increased vascular resistance, and altered cardiac morphology. Hexarelin treatment in GH-deficient models has shown improved cardiac output and ejection fraction, reduction in left ventricular hypertrophy in some models, and improved ventricular contractility — inotropic effects documented in isolated heart preparations.",
    },
    {
      type: "subheading",
