...
export const article: BlogArticle = {
  slug: "buy-research-peptides-usa-guide-jun20-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "For longer peptides (>20 amino acids), or peptides with modifications (fatty acid chains, PEG linkers, arginine substitutions), MS confirmation becomes especially important.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Limulus Amebocyte Lysate (LAL) testing measures endotoxin contamination — bacterial lipopolysaccharide (LPS) and related pyrogens that can elicit severe inflammatory responses in in vivo models. Even small amounts of endotoxin (<1 EU/mL) can confound in vivo inflammatory studies. Most research-grade suppliers should certify <1 EU/mg.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "At Nexphoria, every peptide is synthesized to ≥99% HPLC purity verified by reverse-phase chromatography, confirmed by ESI mass spectrometry for sequence identity, tested for endotoxins via LAL assay with results on every COA, shipped via validated cold-chain protocols, and accompanied by a third-party verified COA accessible on our website by lot number.",
    },
    {
      type: "heading",
      text: "Summary",
