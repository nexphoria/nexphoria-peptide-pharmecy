...
export const article: BlogArticle = {
  slug: "nad-plus-longevity-sirtuins-parp-research-overview",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "NR is a precursor to NMN, then NAD+. It was the first to enter human trials; multiple published RCTs document blood NAD+ elevation (Trammell et al., Nature Communications, 2016). Studied at doses of 250–1000 mg/day in human trials.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor and highly bioavailable, but high doses can inhibit sirtuins via product feedback inhibition — a potential limitation for longevity applications.",
    },
    {
      type: "callout",
