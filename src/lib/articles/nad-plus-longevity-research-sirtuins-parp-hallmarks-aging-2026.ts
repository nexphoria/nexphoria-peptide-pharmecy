...
export const article: BlogArticle = {
  slug: "nad-plus-longevity-research-sirtuins-parp-hallmarks-aging-2026",
  title: "NAD+: Why Longevity Researchers Are Paying Attention",
  description:
    "NAD+ sits at the convergence of energy metabolism, DNA repair, and epigenetic regulation. Learn how sirtuins, PARP enzymes, and NAD+ decline intersect with the hallmarks of aging — and how NMN and NR compare as precursors.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "NAD+ exists in an oxidized (NAD+) and reduced (NADH) form, cycling between them as it shuttles electrons during metabolic processes. It is essential for glycolysis and the TCA cycle (core ATP production pathways), sirtuin activation, PARP-1 activity (DNA damage repair), and CD38 signaling (immune regulation and NAD+ consumption).",
    },
    {
      type: "paragraph",
    ...
    {
      type: "subheading",
      text: "Drivers of NAD+ Decline",
    },
    {
      type: "list",
      items: [
        "Decreased biosynthesis via the salvage pathway (NAMPT activity declines)",
    ...
    {
      type: "callout",
      text: "The competition hypothesis: accumulated DNA damage → PARP hyperactivation → NAD+ depletion → sirtuin suppression → accelerated aging hallmarks. This connects genomic instability, epigenetic alterations, and cellular senescence into one unified mechanistic axis.",
    },
    {
      type: "heading",
    ...
    },
    {
      type: "list",
      items: [
        "Direct precursor to NAD+ via NMNAT enzymes",
        "Studied by David Sinclair (Harvard) and Shin-ichiro Imai (Washington University)",
        "Rodent studies document improvements in metabolic function, muscle performance, and insulin sensitivity with age",
        "Human Phase II trials underway; early data suggests oral bioavailability and measurable NAD+ elevation",
      ],
    },
    {
      type: "subheading",
    ...
    },
    {
      type: "list",
      items: [
        "Precursor to NMN, then NAD+",
        "First to enter human trials; multiple published RCTs documenting blood NAD+ elevation (Trammell et al., Nature Communications, 2016)",
        "Commercially available; studied at doses of 250–1000 mg/day in human trials",
      ],
    },
    {
      type: "subheading",
    ...
    },
    {
      type: "list",
      items: [
        "Simplest precursor; highly bioavailable",
        "High doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity applications",
      ],
    },
    {
      type: "callout",
