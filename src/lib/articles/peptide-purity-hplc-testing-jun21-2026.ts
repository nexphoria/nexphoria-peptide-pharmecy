...
export const article: BlogArticle = {
  slug: "peptide-purity-hplc-testing-jun21-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A purity figure of 99% means that, of all the UV-absorbing material detected by the HPLC system, 99% elutes at the retention time of the target peptide. The remaining 1% consists of synthesis byproducts (deletion sequences, truncated fragments), racemized amino acid-containing variants, oxidized side chains (particularly methionine, cysteine, tryptophan), and protecting group remnants from solid-phase peptide synthesis.",
    },
    {
      type: "paragraph",
    ...
    {
      type: "table",
      headers: ["Standard", "Threshold", "Application"],
      rows: [
        ["Research-grade", "<1 EU/mg", "Standard SC administration protocols"],
        ["Injectable-grade", "<0.1 EU/mg", "IV or IP administration protocols"],
      ],
    },
    {
      type: "heading",
