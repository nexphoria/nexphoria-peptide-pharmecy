...
export const article: BlogArticle = {
  slug: "research-peptides-muscle-recovery-studies",
  title: "5 Research Peptides Used in Muscle Recovery Studies",
  description:
    "BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin have each been examined in muscle recovery and regeneration studies. An evidence-based overview of the preclinical data for each.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "BPC-157 is thought to act via nitric oxide modulation and FAK-paxillin signaling, enhancing cell migration and angiogenesis critical to repair. Key references include Sikiric et al. (multiple publications, University of Zagreb) and Gwyer et al. systematic review (2019).",
    },
    {
      type: "heading",
