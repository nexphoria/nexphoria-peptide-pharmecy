...
export const article: BlogArticle = {
  slug: "peptide-muscle-recovery-five-compound-research-overview",
  title: "5 Research Peptides Used in Muscle Recovery Studies: BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin",
  description:
    "A research-focused overview of five peptide compounds — BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin — examined in skeletal muscle recovery and regeneration studies. Mechanisms, model data, and comparative summary.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "BPC-157 is thought to act via nitric oxide modulation and FAK-paxillin signaling, enhancing cell migration and angiogenesis critical to repair. Key references include Sikiric et al. (University of Zagreb) and the Gwyer et al. systematic review (2019).",
    },
    {
      type: "heading",
    ...
    {
      type: "heading",
      text: "Quality Verification for Research Use",
    },
    {
      type: "paragraph",
      text: "All five peptides require rigorous quality verification for research use: HPLC purity ≥99%, mass spectrometry identity confirmation, endotoxin-free certification (LAL testing), and proper cold-chain shipping and storage protocols.",
    },
    {
      type: "heading",
      text: "Summary",
