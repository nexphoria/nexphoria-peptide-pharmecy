...
export const article: BlogArticle = {
  slug: "how-to-reconstitute-peptides-research-protocol-guide",
  title: "How to Reconstitute Peptides: A Complete Research Protocol Guide",
  description:
    "Step-by-step protocol for reconstituting lyophilized research peptides. Covers diluent selection (bacteriostatic water vs. acetic acid), concentration math, aseptic technique, storage, and common errors to avoid.",
  ...
  body: [
    ...
    {
      type: "callout",
      text: "Research context: This protocol is intended for laboratory research applications only. All compounds and procedures described are for pre-clinical research use.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Peptides in lyophilized form are stable at controlled temperatures for extended periods. Once reconstituted in aqueous solution, they become significantly more vulnerable to degradation through multiple mechanisms:",
    },
    {
      type: "list",
      items: [
        ...
        "Oxidation — especially for methionine- and cysteine-containing sequences",
      ],
    },
    {
      type: "paragraph",
      text: "Getting reconstitution right means choosing the correct diluent, calculating concentration accurately, and following aseptic technique consistently.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Work in a clean environment. Wipe down the preparation surface with 70% isopropyl alcohol. Wash hands thoroughly or use nitrile gloves. In formal lab settings, reconstitution should be performed in a laminar flow hood.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "Draw the calculated volume of diluent into the syringe. Confirm the volume visually against syringe markings before proceeding.",
    },
    {
      type: "subheading",
    ...
    },
    {
      ...
      items: [
        ...
        "Minimize freeze-thaw cycles — each cycle degrades peptide integrity. Pre-aliquot into single-use volumes if repeated use is needed.",
    ...
    },
    {
      ...
      rows: [
        ...
        ["Storing at room temperature", "Accelerated degradation", "Refrigerate immediately after reconstitution"],
      ],
    },
    {
      type: "heading",
