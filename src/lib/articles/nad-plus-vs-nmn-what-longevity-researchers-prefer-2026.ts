...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-what-longevity-researchers-prefer-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. Current evidence favors NMN and NR as more effective than oral NAD+ for systemic NAD+ elevation. Research interest in NMN is growing due to its more direct precursor pathway and emerging human clinical data supporting systemic NAD+ elevation. Interest in combinations with resveratrol or pterostilbene as SIRT1 activators continues, though evidence for synergy remains preliminary.",
    },
    {
      type: "paragraph",
      text: "Notable research directions include tissue-specific delivery — some researchers are investigating whether different precursors preferentially elevate NAD+ in different tissues (e.g., liver vs. muscle vs. brain). NAMPT activators — compounds that upregulate the rate-limiting enzyme in NAD+ biosynthesis — may prove more efficient than precursor loading. CD38 inhibitors are also gaining attention: CD38 is a major NAD+-consuming enzyme, and reducing its activity may complement precursor strategies.",
    },
    {
      type: "heading",
