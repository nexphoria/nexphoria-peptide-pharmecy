...
export const article: BlogArticle = {
  ...
  description:
    "What HPLC certificates mean, how to interpret COAs, endotoxin standards, cold-chain requirements, red flags to avoid, and what separates a research-grade peptide supplier from one that only looks legitimate.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A Certificate of Analysis (COA) is the primary documentation artifact accompanying a research peptide. A comprehensive COA should include peptide identity confirmed by mass spectrometry, HPLC purity with chromatogram, molecular weight (observed vs. theoretical), appearance, solubility, endotoxin level via LAL test, lot/batch number, and testing date.",
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "HPLC tells you how pure a compound is. Mass spectrometry tells you what the compound actually is. ESI-MS (Electrospray Ionization Mass Spectrometry) and MALDI-TOF are the standard methods for peptide identity confirmation. The observed molecular weight should match the theoretical molecular weight within ±0.1–0.5 Da (instrument-dependent).",
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "Limulus Amebocyte Lysate (LAL) testing measures endotoxin contamination — bacterial lipopolysaccharide (LPS) and related pyrogens that can elicit severe inflammatory responses in in vivo models. Even small amounts of endotoxin (<1 EU/mL) can confound in vivo inflammatory studies, producing results attributable to LPS rather than the peptide being studied.",
    },
    {
      type: "paragraph",
      text: "Acceptable standards: Most research-grade suppliers should certify <1 EU/mg. Suppliers offering injectable-grade protocols should target <0.1 EU/mg. IV or IP administration routes carry greater risk than SC for endotoxin-related artifacts.",
    },
    {
      type: "heading",
    ...
    {
      type: "table",
      headers: ["Storage Condition", "Recommended Temperature", "Expected Duration"],
      rows: [
        ["Lyophilized (short-term)", "Room temperature", "Days only"],
        ["Lyophilized (standard)", "-20°C", "12–24 months"],
        ["Reconstituted (working)", "4°C", "28–30 days"],
        ["Long-term research stocks", "-80°C", ">6 months"],
      ],
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "Sourcing research peptides in the USA requires the same rigor as any other component of experimental design. HPLC purity, mass spectrometry identity confirmation, endotoxin testing, and cold-chain compliance are not optional extras — they are the baseline for research-grade material. Evaluate suppliers on documentation quality, not price or marketing language.",
    },
    {
      type: "disclaimer",
