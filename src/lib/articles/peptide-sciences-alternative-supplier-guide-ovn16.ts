...
export const article: BlogArticle = {
  slug: "peptide-sciences-alternative-supplier-guide-ovn16",
  title: "Looking for a Peptide Sciences Alternative? Here's What to Know",
  description:
    "Peptide Sciences shut down in March 2026, leaving thousands of researchers without a supplier. Here's what to look for in a replacement and why documentation standards matter.",
  category: "Industry",
  readMinutes: 8,
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Whatever the cause, the result is the same: tens of thousands of researchers who relied on a familiar vendor are now in a position to reassess. Disruption of any kind forces re-evaluation — and in the research peptide industry, not all suppliers are created equal.",
    },
    {
      type: "heading",
    ...
    {
      type: "heading",
      text: "Evaluating Your New Supplier: A Transition Checklist",
    },
    {
      type: "paragraph",
    ...
    },
    {
      type: "list",
      items: [
        "Inspect packaging integrity and cold-chain indicators upon receipt",
