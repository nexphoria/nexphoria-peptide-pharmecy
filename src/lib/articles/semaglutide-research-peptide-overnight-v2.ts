...
export const aOVN_V2_SEMAGLUTIDE_RESEARCH: BlogArticle = {
  ...
  body: [
    ...
    {
      type: 'subheading',
      text: 'Important Sourcing Considerations',
    },
    {
      type: 'list',
      items: [
