...
export const article: BlogArticle = {
  slug: "research-peptides-muscle-recovery-bpc157-tb500-igf1",
  title: "5 Research Peptides Used in Muscle Recovery Studies",
  description:
    "An evidence-based overview of BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin — five peptides studied in preclinical muscle recovery and regeneration research.",
