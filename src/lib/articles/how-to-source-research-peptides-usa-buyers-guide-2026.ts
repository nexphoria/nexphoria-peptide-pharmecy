...
export const article: BlogArticle = {
  slug: "how-to-source-research-peptides-usa-buyers-guide-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A Certificate of Analysis (COA) is the primary documentation artifact accompanying a research peptide. A comprehensive COA should include: peptide identity (confirmed by mass spectrometry, not just name), HPLC purity (with accompanying chromatogram), molecular weight (observed vs. theoretical with method specified), appearance, solubility confirmed in appropriate solvent, endotoxin level (LAL test result in EU/mg or EU/mL), lot/batch number traceable to your specific shipment, and testing date.",
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "HPLC tells you how pure a compound is. Mass spectrometry tells you what the compound actually is. ESI-MS and MALDI-TOF are the standard methods for peptide identity confirmation. The observed molecular weight should match the theoretical molecular weight of the target sequence within ±0.1–0.5 Da (instrument-dependent). For longer peptides (>20 amino acids), or peptides with modifications (fatty acid chains, PEG linkers, arginine substitutions), MS confirmation becomes especially important — these modifications can be omitted in synthesis without obvious visual changes to the product.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Limulus Amebocyte Lysate (LAL) testing measures endotoxin contamination — bacterial lipopolysaccharide (LPS) and related pyrogens that can elicit severe inflammatory responses in in vivo models. Even small amounts of endotoxin (<1 EU/mL) can confound in vivo inflammatory studies, producing results attributable to LPS rather than the peptide. IV or IP administration routes carry greater risk than SC for endotoxin-related artifacts. Most research-grade suppliers should certify <1 EU/mg; injectable-grade protocols should target <0.1 EU/mg.",
    },
    {
      type: "heading",
