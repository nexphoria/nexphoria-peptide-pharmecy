...
export const article: BlogArticle = {
  ...
  description:
    "A practical guide to sourcing research peptides in the United States — what HPLC certificates mean, why COAs matter, cold-chain requirements, endotoxin testing standards, and red flags that separate credible suppliers from low-quality ones.",
  ...
  body: [
    ...
    },
    {
      ...
      items: [
        ...
        "Endotoxin-contaminated peptides may produce results attributable to LPS rather than the peptide itself",
