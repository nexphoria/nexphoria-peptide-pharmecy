...
export const article: BlogArticle = {
  slug: 'hexarelin-research-cardiac-gh-applications-2026',
  title: 'Hexarelin: Research on Cardiac and GH Applications (2026)',
  description:
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: 'This dual profile — potent GHS activity combined with a GH-independent cardiac mechanism — makes Hexarelin one of the more scientifically interesting research peptides in cardiovascular pre-clinical research.',
    },
    {
      type: 'heading',
