...
export const article: BlogArticle = {
  slug: 'selank-anxiety-research-overview',
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: 'Anxiety disorders represent a significant area of unmet pharmacological research need. Current first-line pharmacological approaches — primarily SSRIs, SNRIs, and benzodiazepines — are associated with well-documented limitations including dependency risk, tolerance development, delayed onset, and cognitive impairment. The search for compounds with anxiolytic activity, rapid onset, and reduced dependency profiles has driven research into several peptide and neuropeptide-based approaches. Selank is among the more extensively studied.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'Uchakina et al. (2008) reported in a human clinical context that Selank reduced anxiety symptoms in patients with generalized anxiety disorder with faster onset than conventional pharmacological treatment, and without the sedating side effects typical of benzodiazepines.',
    },
    {
      type: 'subheading',
    ...
    },
    {
      ...
      items: [
        ...
        'HPLC ≥98% purity and mass spectrometry identity verification recommended',
      ],
    },
    {
      type: 'heading',
