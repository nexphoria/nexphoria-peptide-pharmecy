...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Most peptides are sensitive to UV light. Vials should be stored in original amber or opaque vials, in dark storage areas (refrigerator drawer, wrapped in foil), and away from laboratory UV lamps.",
    },
    {
      type: "paragraph",
    ...
    },
    {
      ...
      items: [
        ...
        "Minimize freeze-thaw cycles — Each cycle adds cumulative structural damage; aliquot before freezing if long-term storage is required",
        "Protect from light — Wrap reconstituted vials in foil or store in opaque containers",
      ],
    },
    {
      type: "subheading",
      text: "Shelf Life by Compound Type",
    },
    {
      type: "list",
      items: [
    ...
    {
      type: "paragraph",
      text: "Before using any stored peptide, inspect the solution. Discard if you observe cloudiness (indicates aggregation or contamination), visible particles, unusual color change (oxidation or other chemical modification), or strong/unusual odor (potential contamination).",
    },
    {
      type: "paragraph",
    ...
    },
    {
      type: "list",
      items: [
        "Use a dedicated laboratory mini-refrigerator for 2–8°C storage — prevents temperature fluctuations from frequently opened shared refrigerators",
        "Use a manual-defrost -20°C freezer — prevents temperature cycling of frost-free models",
