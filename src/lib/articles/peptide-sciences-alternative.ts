...
export const article: BlogArticle = {
  ...
  {
    "type": "paragraph",
    "text": "Whatever the cause, the result is the same: tens of thousands of researchers who relied on a familiar vendor are now in a position to reassess."
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "text": "A Certificate of Analysis should accompany every product and include:"
  },
  {
    "type": "list",
    "items": [
  ...
  {
    "type": "paragraph",
    "text": "If a supplier cannot produce a COA on demand, or provides a single COA for all product variants, that is a disqualifying signal."
  },
  {
    "type": "subheading",
  ...
  {
    "type": "paragraph",
    "text": "A 2022 analysis of commercial peptide products found measurable discrepancies in a substantial portion of samples tested. Misidentified sequences, purity gaps, and contamination from unreacted reagents are documented problems."
  },
  {
    "type": "paragraph",
  ...
  {
    "type": "paragraph",
    "text": "Every Nexphoria product includes:"
  },
  {
    "type": "list",
    "items": [
  ...
  {
    "type": "paragraph",
    "text": "Nexphoria exists to be that supplier: reliable, transparent, and built around the documentation standards serious research requires."
  },
  {
    "type": "paragraph",
