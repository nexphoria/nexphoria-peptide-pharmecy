...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-longevity-research-ovn17",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Oral NAD+ faces a significant bioavailability problem. Research suggests most ingested NAD+ is cleaved in the gut to nicotinamide before absorption. IV NAD+ infusion bypasses this limitation and is used in clinical research contexts. Studies on IV NAD+ have examined effects on neurological function, addiction recovery applications, and acute elevation of tissue NAD+ levels. Subcutaneous and intranasal NAD+ delivery are also under investigation.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape suggests:",
    },
    {
      type: "subheading",
