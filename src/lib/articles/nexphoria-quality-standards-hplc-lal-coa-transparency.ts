...
export const article: BlogArticle = {
  slug: "nexphoria-quality-standards-hplc-lal-coa-transparency",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A Certificate of Analysis is the primary quality document for a research compound. At Nexphoria, every COA includes compound name and full IUPAC name, amino acid sequence in single-letter code, unique batch/lot number for traceability, HPLC purity percentage and chromatogram, MS data with theoretical and observed MW, LAL endotoxin result in EU/mg with pass/fail, testing laboratory name and accreditation, testing date for the specific batch, and recommended storage conditions.",
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "Quality at synthesis is only preserved if the cold chain is maintained through shipping and delivery. Nexphoria ships lyophilized products with cold packs for temperature-sensitive routes, uses amber/opaque vials to protect photosensitive compounds, employs sealed secondary packaging with moisture-control desiccant, and includes temperature indicators on shipments where required.",
    },
    {
      type: "heading",
