...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-researchers-2026-comparison",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "NAD+ levels measurably decline with age across multiple organisms and tissue types. The central challenge is that orally administered NAD+ is poorly absorbed — it is largely degraded in the gut before reaching systemic circulation. This has driven research toward precursor molecules that can be absorbed and converted to NAD+ intracellularly.",
    },
    {
      type: "list",
      items: [
        ...
        "Decreased biosynthesis via the salvage pathway (NAMPT activity declines with age) drives the decline",
        "Elevated CD38 expression in aged tissues degrades NAD+ at accelerating rates",
      ],
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Oral NAD+ faces a significant bioavailability problem. Research suggests most ingested NAD+ is cleaved in the gut to nicotinamide before absorption. IV NAD+ infusion bypasses this limitation and is used in clinical research contexts. Subcutaneous and intranasal NAD+ delivery are also under investigation, with some pre-clinical data suggesting improved bioavailability over oral routes.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape continues to evolve, with several emerging directions attracting significant attention.",
    },
    {
      type: "list",
      items: [
        "In favor of NMN: More direct pathway, emerging human data supports systemic NAD+ elevation",
        "In favor of NR: More extensive human clinical trial base, published safety and tolerability data across multiple studies",
