...
export const article: BlogArticle = {
  slug: "selank-anxiolytic-nootropic-peptide-research-jun20-2026",
  title: "Selank: The Russian Peptide Studied for Anxiety",
  description: "An evidence-based overview of Selank, the heptapeptide developed in Russia and studied for anxiolytic and nootropic effects. Research findings, mechanism of action, and what the published data shows.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Beyond anxiolytic activity, Selank has been studied for cognitive enhancement properties: improved performance on learning and memory tasks in animal studies, reduced cognitive fatigue without stimulant-like effects observed in clinical reports, and neuroprotective properties in some research documenting protection against oxidative stress-induced neuronal damage in cell culture models.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "Selank is a heptapeptide with moderate stability in solution. Lyophilized form is preferred for storage. Reconstituted solutions should be stored at 2–8°C and used within 2–4 weeks. It is sensitive to enzymatic degradation at elevated temperatures.",
    },
    {
      type: "subheading",
