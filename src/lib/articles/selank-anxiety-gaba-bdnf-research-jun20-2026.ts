...
export const article: BlogArticle = {
  slug: "selank-anxiety-gaba-bdnf-research-jun20-2026",
  title: "Selank: The Russian Peptide Studied for Anxiety and Cognitive Enhancement",
  description:
    "An evidence-based overview of Selank — the tuftsin-analog heptapeptide developed in Russia and studied for anxiolytic, nootropic, and immunomodulatory effects. Research findings, mechanism of action, and comparison to conventional approaches.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Selank's anxiolytic effects are thought to involve several intersecting mechanisms. Unlike drugs that act on a single receptor, Selank appears to modulate multiple overlapping pathways — which may contribute to its observed tolerability profile in research models.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "Studies indicate Selank influences serotonergic and dopaminergic transmission, potentially contributing to its reported mood-stabilizing and nootropic effects. The relative contribution of this mechanism compared to GABAergic and enkephalin pathways has not been fully characterized.",
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      rows: [
        ["Selank", "GABAergic modulation, BDNF, enkephalin inhibition", "Approved (Russia)", "Moderate — primarily Russian literature"],
        ["Semax", "ACTH 4-7 analog, BDNF upregulation", "Approved (Russia)", "Moderate — similar evidence base"],
    ...
    },
    {
      type: "list",
      items: [
        "Lyophilized form is preferred for storage; stable for 12–24 months at -20°C",
        "Reconstituted solutions: store at 2–8°C, use within 2–4 weeks",
        "Sensitive to enzymatic degradation at elevated temperatures",
        "Protect from UV light; store in opaque or amber vials",
      ],
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "Given CNS research applications, purity standards are particularly important. HPLC ≥98% and mass spectrometry identity verification should be confirmed in supplier Certificate of Analysis (COA) documentation. Trace impurities in compounds intended for CNS research can introduce confounding variables.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "This does not invalidate the research, but it does mean the evidence has not been subjected to the degree of independent scrutiny standard in globally-replicated pharmacological research. Selank remains a research-stage compound for Western investigators, with independent replication the primary evidence gap.",
    },
    {
      type: "heading",
      text: "Summary",
