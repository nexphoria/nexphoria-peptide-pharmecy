...
export const article: BlogArticle = {
  slug: "longevity-peptide-stack-2026-hallmarks-research-guide",
  title: "The 2026 Longevity Peptide Stack: A Hallmarks-of-Aging Research Guide",
  description:
    "A research-oriented overview of the peptide combinations longevity scientists are investigating in 2026. Covers GH axis, telomere biology, tissue repair, mitochondrial targets, and neurological maintenance across five research tiers.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Humanin is another MDP — one of the first identified — with documented roles in neuroprotection (originally identified in Alzheimer's disease context), cardiovascular protection, metabolic regulation, and circulating levels that decline with age.",
    },
    {
      type: "paragraph",
      text: "Humanin and MOTS-c are increasingly studied together as a mitochondria-derived peptide combination targeting multiple aspects of mitochondrial decline.",
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      rows: [
        ...
        ["Compound purity / endotoxin load", "LAL-tested, HPLC ≥98% sourcing"],
      ],
    },
    {
      type: "heading",
