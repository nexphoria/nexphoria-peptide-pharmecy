...
export const article: BlogArticle = {
  ...
  },
  {
    ...
    "rows": [
      [
        "No COA available pre-purchase",
        "Transparency is non-negotiable"
      ],
      [
        "COA on request only",
        "Suggests inconsistency across lots"
      ],
      [
        "HPLC purity listed as <98%",
        "Below research-grade threshold"
      ],
      [
      ...
      [
        ...
        "In vivo results may be confounded"
      ],
      [
        "Ambient-temperature shipping",
        "Peptide degradation likely"
      ],
      [
        "No lot/batch number on COA",
        "Cannot verify your specific product"
      ],
      [
        "Unusually low prices",
        "Synthesis corners being cut"
      ]
    ]
  },
  {
  ...
  {
    "type": "paragraph",
    "text": "At Nexphoria, every peptide is:"
  },
  {
    "type": "list",
    "items": [
      "Synthesized to ≥99% HPLC purity, verified by reverse-phase chromatography",
      "Confirmed by ESI mass spectrometry for sequence identity",
      "Tested for endotoxins via LAL assay — results included on every COA",
      "Shipped via validated cold-chain protocols with temperature-controlled packaging",
      "Accompanied by a third-party verified COA, accessible on our website by lot number"
    ]
  },
  {
    "type": "paragraph",
