...
export const article: BlogArticle = {
  slug: "peptide-sciences-shutdown-supplier-transition-guide",
  title: "Peptide Sciences Shutdown: A Researcher's Supplier Transition Guide",
  description:
    "Peptide Sciences shut down in March 2026, leaving thousands of researchers without a trusted source. A rigorous framework for evaluating replacement suppliers — and what sets credible vendors apart.",
  category: "Industry",
  readMinutes: 8,
