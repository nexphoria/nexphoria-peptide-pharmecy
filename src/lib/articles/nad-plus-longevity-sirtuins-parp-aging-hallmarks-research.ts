...
export const article: BlogArticle = {
  slug: "nad-plus-longevity-sirtuins-parp-aging-hallmarks-research",
  title: "NAD+ and the Hallmarks of Aging: Why Longevity Researchers Are Paying Attention",
  description:
    "NAD+ sits at the convergence of energy metabolism, DNA repair, epigenetic regulation, and mitochondrial biology. A deep-dive into the science: sirtuin activation, PARP competition, the López-Otín aging hallmarks, and the current state of NMN vs NR precursor research.",
  ...
  body: [
    ...
    },
    {
      ...
      items: [
        ...
        "Elevated CD38 expression in aged tissues, which constitutively degrades NAD+",
      ],
    },
    {
      type: "heading",
    ...
    {
      type: "callout",
      text: "The competition hypothesis: accumulated DNA damage → PARP hyperactivation → NAD+ depletion → sirtuin suppression → accelerated aging hallmarks. This mechanistic cascade connects genomic instability to epigenetic dysfunction through a single metabolic bottleneck.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "The landmark 2013 paper by López-Otín et al. in Cell identified 9 hallmarks of aging. NAD+ biology intersects with at least five of them, which explains the sustained research investment in this pathway.",
    },
    {
      type: "table",
      headers: ["Hallmark of Aging", "NAD+ Connection"],
      rows: [
    ...
    {
      type: "paragraph",
      text: "NR is a precursor to NMN, then NAD+. It was the first NAD+ precursor to enter human trials, with multiple published RCTs documenting blood NAD+ elevation (Trammell et al., Nature Communications, 2016). Commercially available and studied at doses of 250–1000 mg/day in human trials.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "The simplest precursor, highly bioavailable. However, high doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity applications. This paradox makes NAM less attractive than NMN or NR for applications targeting sirtuin activation.",
    },
    {
      type: "callout",
    ...
    {
      type: "heading",
      text: "Research Tools: NAD+ Study Models",
    },
    {
      type: "list",
      items: [
        "Genetic models — SIRT1 knockout, CD38 knockout mice to isolate mechanistic contributions",
        ...
        "Human trials — blood NAD+ metabolomics, muscle biopsy NAD+ quantification",
      ],
    },
    {
      type: "heading",
