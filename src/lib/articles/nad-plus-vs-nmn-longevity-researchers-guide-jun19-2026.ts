...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-longevity-researchers-guide-jun19-2026",
  title: "NAD+ vs NMN: What Longevity Researchers Need to Know",
  description:
    "A research-focused comparison of NAD+ precursors NMN and NR versus direct NAD+ supplementation. Covers mechanism, bioavailability data, the STEP and Sinclair lab research, tissue-specific delivery questions, and the peptide connection to mitochondria-derived compounds.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Oral NAD+ faces a significant bioavailability problem — most ingested NAD+ is cleaved in the gut to nicotinamide before absorption. IV NAD+ infusion bypasses this limitation and is used in clinical research contexts, with studies examining effects on neurological function, addiction recovery applications (early research, limited evidence), and acute elevation of tissue NAD+ levels. Subcutaneous and intranasal NAD+ delivery are also under investigation, with some pre-clinical data suggesting improved bioavailability over oral routes.",
    },
    {
      type: "divider",
    },
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape shows advantages for both NMN and NR depending on the research context.",
    },
    {
      type: "subheading",
    ...
    },
    {
      type: "list",
      items: [
        "More direct pathway to NAD+ biosynthesis",
