...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-nr-direct-comparison-2026",
  title: "NAD+ vs NMN vs NR: What Longevity Researchers Prefer in 2026",
  description:
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape suggests NMN offers a more direct pathway with emerging human data supporting systemic NAD+ elevation, while NR has a more extensive human clinical trial base with published safety and tolerability data.",
    },
    {
      type: "list",
      items: [
        "Tissue-specific delivery — some researchers investigate whether different precursors preferentially elevate NAD+ in different tissues (liver vs. muscle vs. brain)",
