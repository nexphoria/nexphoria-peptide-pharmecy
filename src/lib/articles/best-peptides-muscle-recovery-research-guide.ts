...
export const article: BlogArticle = {
  ...
  description:
    "An evidence-based overview of five peptides — BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin — that appear frequently in preclinical muscle recovery and regeneration research.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "All five peptides require rigorous quality verification before use in research protocols.",
    },
    {
      type: "list",
      items: [
