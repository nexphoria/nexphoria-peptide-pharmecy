...
export const article: BlogArticle = {
  slug: "peptide-storage-best-practices-2026",
  title: "Peptide Storage Best Practices: Temperature, Light, and Shelf Life (2026)",
  description:
    "Research-grade guidelines for storing lyophilized and reconstituted peptides in 2026. Covers temperature requirements, light sensitivity, freeze-thaw cycles, shelf life by compound type, and signs of degradation.",
  ...
  body: [
    ...
    {
      type: "subheading",
      text: "Standard Storage Temperatures and Expected Shelf Life",
    },
    {
      type: "list",
      items: [
    ...
    {
      type: "paragraph",
      text: "Most peptides are sensitive to UV light. Vials should be stored in original amber or opaque vials, a dark storage area (refrigerator drawer, wrapped in foil), and away from laboratory UV lamps. Peptides containing tryptophan (Trp/W) residues are particularly photosensitive — this includes compounds like GHRP-2, GHRP-6, and Hexarelin.",
    },
    {
      type: "heading",
    ...
    },
    {
      type: "list",
      items: [
        "Short peptides (2–5 AA): 4–8 weeks refrigerated — generally more stable",
    ...
    {
      type: "paragraph",
      text: "Before using any stored peptide, inspect the solution for signs of compromise.",
    },
    {
      type: "subheading",
