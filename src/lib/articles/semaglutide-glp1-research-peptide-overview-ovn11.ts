...
export const article: BlogArticle = {
  slug: "semaglutide-glp1-research-peptide-overview",
  title: "Semaglutide as a Research Peptide: What the Studies Show",
  description:
    "Semaglutide as a research tool: GLP-1 receptor agonism mechanisms, published STEP and SUSTAIN-6 trial data, metabolic and neurological research applications, and quality standards for researchers working with this compound.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The most widely cited human clinical research on semaglutide is the STEP (Semaglutide Treatment Effect in People with Obesity) trial program, published in The New England Journal of Medicine. STEP 1 (Wilding et al., 2021) — a 68-week double-blind RCT — found participants receiving semaglutide 2.4 mg weekly achieved a mean body weight reduction of 14.9% versus 2.4% in the placebo group. STEP 3 (Wadden et al., 2021) combined semaglutide with intensive behavioral intervention, yielding an average weight reduction of 16%. STEP 4 (Rubino et al., 2021) demonstrated weight regain upon cessation, confirming that metabolic effects are pharmacodynamically sustained only during active treatment.",
    },
    {
      type: "subheading",
