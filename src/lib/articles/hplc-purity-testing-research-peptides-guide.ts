...
export const article: BlogArticle = {
  slug: "hplc-purity-testing-research-peptides-guide",
  title: "Why HPLC Purity Testing Matters When Sourcing Research Peptides",
  description:
    "What HPLC purity testing actually measures, why the ≥99% threshold exists for experimental validity, and how it integrates with mass spectrometry and LAL endotoxin testing.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A research-grade peptide purity assessment is typically conducted via the following steps: sample preparation (peptide dissolved in a defined solvent, often 0.1% TFA in water/acetonitrile); injection onto C18 RP column; gradient elution (increasing acetonitrile concentration displaces bound compounds in order of hydrophobicity); UV detection (typically at 220 nm for peptide bond absorption and 280 nm for aromatic residues); and integration (software integrates peak areas, with purity expressed as area % of the main peak).",
    },
    {
      type: "paragraph",
