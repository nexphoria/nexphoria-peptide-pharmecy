...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "MOTS-c is a mitochondria-derived peptide (MDP) encoded within the mitochondrial 12S rRNA. Research findings include insulin sensitization (reversal of diet-induced insulin resistance in mouse models), exercise-mimetic effects via AMPK activation, and lifespan extension demonstrated in C. elegans. Age-dependent decline in MOTS-c levels suggests it as both a biomarker and potential intervention target.",
    },
    {
      type: "subheading",
      text: "Humanin",
    ...
    {
      type: "paragraph",
      text: "Humanin is another MDP — one of the first identified — with documented roles in neuroprotection (originally identified in the Alzheimer's disease context), cardiovascular protection, and metabolic regulation. Humanin and MOTS-c are increasingly studied together as a mitochondria-derived peptide combination targeting multiple aspects of mitochondrial decline.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Russia's two most studied nootropic peptides represent CNS-focused longevity components. Semax (ACTH 4-7 analog) is associated with BDNF upregulation, neuroprotection, and cognitive enhancement. Selank (tuftsin analog) has been studied for anxiolytic, BDNF-upregulating, and immunomodulatory properties.",
    },
    {
      type: "paragraph",
    ...
    },
    {
      ...
      items: [
        ...
        "Inflammatory load → Address via compound purity (LAL testing)",
      ],
    },
    {
      type: "heading",
