...
export const article: BlogArticle = {
  slug: "muscle-recovery-peptides-five-compound-research-overview",
  title: "5 Research Peptides Used in Muscle Recovery Studies",
  description:
    "BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin have all been examined in skeletal muscle repair research. This overview summarizes the preclinical evidence for each compound and what makes them scientifically distinct.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "BPC-157 is thought to act via nitric oxide modulation and FAK-paxillin signaling, enhancing cell migration and angiogenesis critical to tissue repair. Study references include multiple publications from Sikiric et al. (University of Zagreb) and the Gwyer et al. systematic review (2019).",
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      rows: [
        ...
        ["Follistatin-344", "Myostatin/ActRIIB", "TGF-β superfamily inhibition", "Murine models"],
        ["Ipamorelin", "GHSR-1a", "GH pulse stimulation", "Rodent models"],
      ],
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "All five peptides require rigorous quality verification before inclusion in any research protocol. Minimum standards should include HPLC purity ≥99%, mass spectrometry identity confirmation, endotoxin-free certification (LAL testing), and adherence to cold-chain shipping and storage protocols. Variability in peptide purity between suppliers is a documented confound in preclinical research and must be controlled for in any study comparing findings across literature.",
    },
    {
      type: "heading",
      text: "Summary",
