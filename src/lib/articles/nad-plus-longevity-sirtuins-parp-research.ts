...
export const article: BlogArticle = {
  slug: "nad-plus-longevity-sirtuins-parp-research",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "NR is a precursor to NMN, then NAD+. It was the first to enter human trials, with multiple published RCTs documenting blood NAD+ elevation (Trammell et al., Nature Communications, 2016). Commercially available; studied at doses of 250–1000 mg/day in human trials.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor with high bioavailability. However, high doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity applications.",
    },
    {
      type: "paragraph",
