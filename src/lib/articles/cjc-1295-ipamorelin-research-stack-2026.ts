...
export const article: BlogArticle = {
  slug: "cjc-1295-ipamorelin-research-stack-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The combination of a GHRH analog with a GHS targets two independent but synergistic pathways. CJC-1295 activates the GHRH receptor, promoting GH synthesis, while Ipamorelin activates GHS-R1a, triggering GH release — creating a 'double signal' that increases available GH and one that triggers its secretion.",
    },
    {
      type: "paragraph",
    ...
    {
      type: "callout",
      text: "These dosing parameters reflect protocols described in research literature only. They do not constitute clinical recommendations or dosing guidance for human use.",
    },
    {
      type: "heading",
