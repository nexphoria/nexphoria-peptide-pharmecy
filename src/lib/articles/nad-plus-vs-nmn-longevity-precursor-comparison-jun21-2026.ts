...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-longevity-precursor-comparison-jun21-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape suggests NMN has a more direct pathway with emerging human data supporting systemic NAD+ elevation, while NR has a more extensive human clinical trial base with published safety and tolerability data across multiple studies.",
    },
    {
      type: "paragraph",
      text: "Notable research directions include tissue-specific delivery — some researchers are investigating whether different precursors preferentially elevate NAD+ in different tissues (e.g., liver vs. muscle vs. brain) — as well as NAMPT activators that upregulate the enzyme limiting NAD+ biosynthesis from nicotinamide, and CD38 inhibitors that reduce NAD+ consumption.",
    },
    {
      type: "heading",
