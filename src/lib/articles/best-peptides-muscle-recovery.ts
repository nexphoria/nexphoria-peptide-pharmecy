...
export const article: BlogArticle = {
  slug: "best-peptides-muscle-recovery",
  title: "5 Research Peptides Used in Muscle Recovery Studies",
  description:
    "BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin have each been examined in preclinical muscle recovery and regeneration studies. Here's an evidence-based summary of what the research shows for each compound.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "All five peptides require rigorous quality verification. Research-grade standards include HPLC purity ≥99%, mass spectrometry identity confirmation, endotoxin-free certification (LAL testing), and cold-chain shipping and storage protocols.",
    },
    {
      type: "heading",
      text: "Summary",
