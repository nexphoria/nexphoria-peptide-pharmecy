...
export const article: BlogArticle = {
  slug: "how-to-reconstitute-peptides-research-protocol-guide-2026",
  title: "How to Reconstitute Peptides: A Research Protocol Guide",
  description:
    "Step-by-step research protocol for reconstituting lyophilized peptides. Covers bacteriostatic water, acetic acid, dilution math, and storage best practices for accurate, reproducible research.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Determine the concentration needed for your research protocol before adding any liquid. The standard formula: Concentration (mcg/mL) = Peptide mass (mcg) ÷ Volume of diluent (mL). Example: a 5 mg (5,000 mcg) vial at target concentration 2 mg/mL requires 5,000 ÷ 2,000 = 2.5 mL of diluent. For a 1 mg/mL concentration from the same vial, add 5 mL of diluent.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "Once reconstituted, peptide stability decreases. For short-term storage (up to 4 weeks), store in a refrigerator at 2–8°C and keep away from light. Minimize freeze-thaw cycles — each cycle degrades peptide integrity; pre-aliquot if multiple use sessions are planned. Label each vial with compound name, concentration, reconstitution date, and lot number. Discard if solution becomes cloudy, discolored, or shows visible particulates.",
    },
    {
      type: "heading",
