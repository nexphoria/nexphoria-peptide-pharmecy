...
export const article: BlogArticle = {
  slug: "peptide-purity-hplc-testing-research-guide",
  title: "Why HPLC Purity Testing Matters When Sourcing Peptides",
  description:
    "A technical explanation of how HPLC purity testing works, why the 99% research-grade threshold exists, and how it integrates with mass spectrometry and LAL endotoxin testing for complete analytical verification of research peptides.",
