...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-longevity-precursor-comparison",
  title: "NAD+ vs NMN: What Longevity Researchers Prefer",
  description:
    "A research-focused comparison of NAD+ precursors NMN and NR versus direct NAD+ supplementation. What the published science says about bioavailability, mechanism, sirtuin activation, and longevity research applications in 2026.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape reflects ongoing parallel investigation rather than a definitive winner.",
    },
    {
      type: "subheading",
      text: "Arguments for NMN",
    },
    {
      type: "list",
      items: [
        "More direct biosynthetic pathway to NAD+",
        "Emerging human data supports systemic NAD+ elevation",
        "Interest in combining NMN with resveratrol or pterostilbene as SIRT1 activators (synergy evidence remains preliminary)",
        "Dedicated intestinal transporter (Slc12a8) supports efficient uptake",
      ],
    },
    {
      type: "subheading",
      text: "Arguments for NR",
    },
    {
      type: "list",
      items: [
        ...
        "Easier formulation stability at room temperature",
        "Multiple sponsored and independent trial replications",
      ],
    },
    {
      type: "subheading",
      text: "Notable Emerging Research Directions",
    },
    {
      type: "list",
      items: [
        ...
        "Combination protocols — NAD+ precursors + sirtuins activators + mitophagy inducers",
      ],
    },
    {
      type: "heading",
