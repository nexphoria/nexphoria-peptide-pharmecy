...
export const article: BlogArticle = {
  ...
  description:
    "A research-focused overview of the CJC-1295 and Ipamorelin combination — mechanisms, published data, dual-pathway somatotropic synergy, and what the science says about this growth hormone secretagogue stack.",
  category: "GH Axis",
  readMinutes: 9,
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A 2006 study published in the Journal of Clinical Endocrinology & Metabolism (Teichman et al.) administered CJC-1295 to healthy adult subjects. Key observations included dose-dependent increases in plasma GH — up to 10-fold above baseline in some subjects — and sustained IGF-1 elevation lasting 9–11 days after a single dose. Notably, CJC-1295 appeared to amplify rather than replace endogenous GH secretion rhythms, preserving pulsatile GH release. This pulsatility preservation is a key distinction from exogenous GH administration, which typically suppresses endogenous production.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "Research on Ipamorelin, primarily in animal models, has documented robust GH pulse stimulation comparable to GHRP-6 at equivalent molar doses, along with reduced off-target hormone release. A study by Elbrønd et al. (1999) in swine demonstrated significant, dose-dependent GH release with Ipamorelin, with a favorable selectivity profile compared to GHRP-2. Ipamorelin's selectivity for GH over cortisol distinguishes it from less selective GHS compounds.",
    },
    {
      type: "subheading",
      text: "Mechanism Summary",
    ...
    {
      type: "paragraph",
      text: "Studies examining co-administration of GHRH analogs with GHS compounds have consistently shown greater GH output than either compound alone — a pattern consistent with synergistic rather than simply additive interaction. Additionally, GHS-R1a agonism has been shown to suppress somatostatin tone, reducing the inhibitory brake on GH release. This further augments the response to concurrent GHRH stimulation.",
    },
    {
      type: "heading",
