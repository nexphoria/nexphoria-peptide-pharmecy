...
export const article: BlogArticle = {
  slug: "hexarelin-cd36-cardiac-research-jun19-2026",
  title: "Hexarelin: CD36, Cardioprotection, and GH Research — 2026 Overview",
  description:
    "An evidence-based research overview of Hexarelin — a synthetic hexapeptide studied for growth hormone secretagogue activity and cardioprotective effects via the CD36 receptor pathway.",
