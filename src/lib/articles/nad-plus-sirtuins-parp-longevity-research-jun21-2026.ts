...
export const article: BlogArticle = {
  slug: "nad-plus-sirtuins-parp-longevity-research-jun21-2026",
  title: "NAD+: Why Longevity Researchers Are Paying Attention",
  description:
    "NAD+ is a central molecule in longevity research — driving sirtuin activation, PARP DNA repair, and mitochondrial regulation. This overview covers the science behind NAD+ decline, its connection to the hallmarks of aging, and the current state of precursor research (NMN, NR, NAM).",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "NAD+ exists in an oxidized (NAD+) and reduced (NADH) form, cycling between them as it shuttles electrons during metabolic processes. It is essential for glycolysis and the TCA cycle (core ATP production pathways), sirtuin activation (the NAD+-dependent deacetylase enzymes central to aging research), PARP-1 activity for DNA damage repair, and CD38 signaling in immune regulation and NAD+ consumption.",
    },
    {
      type: "paragraph",
      text: "The critical issue identified in aging research is that NAD+ levels decline with age across multiple tissues. Studies in rodents and humans have documented NAD+ reductions of 40–60% between young adulthood and middle age, with further decline into senescence. The drivers of this decline appear to be multifactorial: decreased biosynthesis via the salvage pathway (NAMPT activity declines), increased consumption by PARP enzymes in response to cumulative DNA damage, and elevated CD38 expression in aged tissues, which degrades NAD+.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "The landmark 2013 paper by López-Otín et al. in Cell identified 9 hallmarks of aging. NAD+ biology intersects with at least five of them, which is a key reason NAD+ has attracted sustained research attention — it is not a narrow intervention but a potential modulator of core aging biology.",
    },
    {
      type: "table",
    ...
    {
      type: "paragraph",
      text: "NR is a precursor to NMN, then NAD+. It was the first to enter human trials, with multiple published RCTs documenting blood NAD+ elevation (Trammell et al., Nature Communications, 2016). It is commercially available and has been studied at doses of 250–1000 mg/day in human trials.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor and highly bioavailable, but high doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity applications.",
    },
    {
      type: "callout",
