...
export const article: BlogArticle = {
  slug: "nad-plus-longevity-researchers-guide",
  title: "NAD+: Why Longevity Researchers Are Paying Attention",
  description:
    "NAD+ sits at the intersection of energy metabolism, DNA repair, sirtuin biology, and the hallmarks of aging. An evidence-based overview of why longevity researchers study NAD+ precursors — NMN, NR, and beyond.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The drivers of this decline appear to be multifactorial:",
    },
    {
      type: "list",
      items: [
    ...
    {
      type: "paragraph",
      text: "This has led to the competition hypothesis: accumulated DNA damage → PARP hyperactivation → NAD+ depletion → sirtuin suppression → accelerated aging hallmarks.",
    },
    {
      type: "list",
      items: [
        "Genomic instability (Hallmark #1 of aging per López-Otín et al.)",
        "Epigenetic alterations (Hallmark #4)",
    ...
    },
    {
      ...
      rows: [
        ...
        ["Mitochondrial dysfunction", "SIRT3 mitochondrial quality regulation"],
      ],
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "NR is a precursor to NMN, then NAD+. It was the first to enter human trials, with multiple published RCTs documenting blood NAD+ elevation (Trammell et al., Nature Communications, 2016). Commercially available; studied at doses of 250–1000 mg/day in human clinical trials.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor, highly bioavailable. However, high doses can inhibit sirtuins via product feedback inhibition — a potential limitation for longevity applications.",
    },
    {
      type: "callout",
      text: "Key distinction: NMN has a more direct biosynthetic route but lower current volume of human clinical data. NR has more published human RCT data but requires an additional enzymatic step. Both elevate blood NAD+ effectively in human studies; tissue-specific distribution differences remain under investigation.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "In research settings, NAD+ biology is typically studied through:",
    },
    {
      type: "list",
      items: [
        "Genetic models — SIRT1 knockout, CD38 knockout mice",
        "NAD+ depletion models — NAMPT inhibitor treatment to study downstream effects",
    ...
    {
      type: "heading",
      text: "NAD+ in Combination Longevity Protocols",
    },
    {
      type: "paragraph",
      text: "Because NAD+ addresses mitochondrial dysfunction and epigenetic drift but does not directly target tissue repair or telomere biology, research increasingly examines it in combination with complementary compounds. Common research combinations include:",
    },
    {
      type: "list",
      items: [
        "NAD+ precursors + Epithalon — addressing both mitochondrial aging and telomere attrition simultaneously",
        "NAD+ precursors + SS-31 (Elamipretide) — dual mitochondrial targeting with distinct mechanisms",
        "NAD+ precursors + GHK-Cu — NAD+ for intracellular energetics, GHK-Cu for extracellular matrix maintenance and Nrf2 activation",
        "NAD+ precursors + Senolytics — clearing senescent cells while restoring mitochondrial function",
      ],
    },
    {
      type: "heading",
