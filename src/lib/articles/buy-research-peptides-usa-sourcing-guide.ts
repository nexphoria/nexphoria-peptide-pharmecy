...
export const article: BlogArticle = {
  slug: "buy-research-peptides-usa-sourcing-guide",
  title: "How to Source Research Peptides in the USA: A Buyer's Guide",
  description:
    "What HPLC certificates mean, why COAs matter, cold-chain requirements, red flags to avoid, and what sets premium peptide suppliers apart. A practical guide for researchers sourcing in the United States.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A Certificate of Analysis (COA) is the primary documentation artifact accompanying a research peptide. A comprehensive COA should include peptide identity (confirmed by mass spectrometry, not just name), HPLC purity with accompanying chromatogram, molecular weight (observed vs. theoretical with method specified), appearance description, solubility confirmed in appropriate solvent, endotoxin level via LAL test result, lot/batch number traceable to your specific shipment, and testing date.",
    },
    {
      type: "paragraph",
      text: "Recency matters: peptides degrade; old COAs may not reflect the current lot. Third-party COAs (performed by independent analytical laboratories) are more credible than in-house COAs performed by the seller's own lab. Suppliers who publish third-party COAs — and make them accessible without requiring a purchase — signal greater transparency and accountability.",
    },
    {
      type: "heading",
    ...
    },
    {
      type: "list",
      items: [
        "Ice packs (4°C) are acceptable for lyophilized peptides during 2–3 day transit",
