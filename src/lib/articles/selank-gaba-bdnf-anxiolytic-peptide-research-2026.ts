...
export const article: BlogArticle = {
  slug: "selank-gaba-bdnf-anxiolytic-peptide-research-2026",
  title: "Selank: GABAergic Modulation, BDNF Upregulation, and Anxiolytic Research",
  description: "An evidence-based research overview of Selank, the synthetic heptapeptide studied for anxiolytic and nootropic effects via GABAergic modulation, BDNF upregulation, and enkephalin stabilization.",
