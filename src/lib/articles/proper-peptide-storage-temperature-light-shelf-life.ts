...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Most peptides are sensitive to UV light. Vials should be stored in original amber or opaque vials, in a dark storage area (refrigerator drawer, wrapped in foil), and away from laboratory UV lamps. Peptides containing tryptophan (Trp/W) residues are particularly photosensitive — this includes compounds like GHRP-2, GHRP-6, and Hexarelin.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Before using any stored peptide, inspect the solution. Discard if you observe cloudiness (indicates aggregation or contamination), visible particles, unusual color change, or strong or unusual odor. These warrant discard: when in doubt, do not proceed with the experiment.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Every stored peptide vial should be labeled with: compound name and catalog ID, lot or batch number, date received, date reconstituted (if applicable), concentration (if reconstituted), and researcher initials.",
    },
    {
      type: "callout",
      text: "All Nexphoria shipments include lot-specific COAs and are cold-chain handled end-to-end — so researchers receive material at full certified purity, ready for storage per protocol.",
    },
    {
      type: "disclaimer",
      text: "This content is for educational and research purposes only. Not intended for human use.",
    },
  ],
};
