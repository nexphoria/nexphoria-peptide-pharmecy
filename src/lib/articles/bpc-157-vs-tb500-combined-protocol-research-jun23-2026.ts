...
export const article: BlogArticle = {
  slug: "bpc-157-vs-tb500-combined-protocol-research",
  title: "BPC-157 + TB-500: Research on the Combined Protocol",
  description:
    "BPC-157 and TB-500 are frequently studied together in preclinical tissue-repair models. This article examines the mechanistic rationale for combined protocols, what the available literature shows, and quality standards for sourcing both peptides.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "In preclinical models, combined BPC-157 + TB-500 protocols typically use established rodent dosing parameters for each compound independently.",
    },
    {
      type: "subheading",
