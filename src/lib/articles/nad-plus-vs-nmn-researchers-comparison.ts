...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-researchers-comparison",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "NAD+ levels measurably decline with age across multiple organisms and tissue types. Key data points from the literature:",
    },
    {
      type: "list",
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        "Active research interest in NMN + resveratrol combination protocols",
      ],
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "Oral NAD+ faces a significant bioavailability problem. Research suggests most ingested NAD+ is cleaved in the gut to nicotinamide before absorption. IV NAD+ infusion bypasses this limitation and is used in clinical research contexts for neurological function studies, addiction recovery applications, and acute elevation of tissue NAD+ levels. Subcutaneous and intranasal NAD+ delivery are also under investigation, with some pre-clinical data suggesting improved bioavailability over oral routes.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape suggests distinct advantages for different approaches:",
    },
    {
      type: "subheading",
    ...
    },
    {
      ...
      items: [
        ...
        "Dedicated intestinal transporter (Slc12a8) suggests efficient uptake mechanism",
        "Active investigation of NMN + SIRT1 activator combinations",
      ],
    },
    {
      type: "subheading",
    ...
    },
    {
      ...
      items: [
        ...
        "Easier formulation stability for commercial production",
        "ChromaDex and Elysium-sponsored trial infrastructure creates ongoing data generation",
      ],
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      items: [
        ...
        "Combination protocols pairing precursors with senolytics or mitochondrial-targeted compounds",
      ],
    },
    {
      type: "heading",
