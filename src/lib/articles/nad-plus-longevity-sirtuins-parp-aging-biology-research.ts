...
export const article: BlogArticle = {
  slug: "nad-plus-longevity-sirtuins-parp-aging-biology-research",
  title: "NAD+: Why Longevity Researchers Are Paying Attention",
  description:
    "NAD+ in longevity research — why it declines with age, its role in sirtuin activation, PARP-1 competition, the hallmarks of aging, and how NMN and NR compare as NAD+ precursors.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The drivers of this decline appear to be multifactorial: decreased biosynthesis via the salvage pathway as NAMPT activity declines, increased consumption by PARP enzymes in response to cumulative DNA damage, and elevated CD38 expression in aged tissues that degrades NAD+.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "The landmark 2013 paper by López-Otín et al. in Cell identified 9 hallmarks of aging. NAD+ biology intersects with at least five of them: genomic instability via PARP-1 dependent repair; epigenetic alterations via sirtuin-mediated histone deacetylation; loss of proteostasis via SIRT1 regulation of autophagy; deregulated nutrient sensing via SIRT1/SIRT3 in insulin/mTOR pathways; and mitochondrial dysfunction via SIRT3 mitochondrial regulation. This breadth of mechanistic connection is a key reason NAD+ has attracted sustained research attention — it is not a narrow intervention but a potential modulator of core aging biology.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor with high bioavailability. However, high doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity applications where sirtuin activation is a key objective.",
    },
    {
      type: "subheading",
    ...
    },
    {
      type: "list",
      items: [
        "NMN has a more direct biosynthetic route but lower current volume of human clinical data",
        "NR has more published human RCT data but requires an additional enzymatic step",
        "Both elevate blood NAD+ effectively in human studies; tissue-specific distribution differences remain under investigation",
        "NAM is simplest but carries sirtuin inhibition risk at high doses",
      ],
    },
    {
      type: "heading",
