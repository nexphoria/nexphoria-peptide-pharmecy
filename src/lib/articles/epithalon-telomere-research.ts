...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Supported by current data: telomerase activation by Epithalon in cell culture models is documented; animal longevity effects across multiple model organisms have been reported; the tetrapeptide appears to have a favorable safety profile in the studies conducted.",
    },
    {
      type: "paragraph",
      text: "Not yet established: independent replication of the core telomerase activation finding in human cells; controlled human clinical trial data meeting modern RCT standards; dose-response characterization in mammalian in vivo models; long-term safety profile in human populations.",
    },
    {
      type: "heading",
