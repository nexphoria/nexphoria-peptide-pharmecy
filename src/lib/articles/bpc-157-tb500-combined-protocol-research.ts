...
export const article: BlogArticle = {
  slug: "bpc-157-tb500-combined-protocol-research",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "To understand the rationale for combined research protocols, it helps to contrast each compound's primary mechanism. BPC-157 is a 15 amino acid peptide working primarily through NO modulation, VEGF, and FAK-paxillin signaling — with systemic anti-inflammatory effects and strong angiogenic activity. TB-500 is a 43 amino acid peptide working via G-actin sequestration and VEGF, with local NF-κB anti-inflammatory effects and direct cell migration facilitation.",
    },
    {
      type: "table",
    ...
    {
      type: "paragraph",
      text: "In preclinical models, combined BPC-157 + TB-500 protocols typically use the following dosing parameters:",
    },
    {
      type: "subheading",
      text: "BPC-157 (rodent models)",
    },
    {
      type: "list",
      items: [
    ...
    {
      type: "paragraph",
      text: "Researchers requiring both compounds for a combined protocol should apply uniform quality standards across both. For BPC-157: HPLC ≥99% purity (chromatogram required), ESI-MS molecular weight confirmation, LAL endotoxin testing (<1 EU/mg), lyophilized form with cold-chain shipping. For TB-500: HPLC ≥99% purity is particularly important for the 43-amino acid sequence (more potential truncation points), ESI-MS or MALDI-TOF confirmation (confirm MW: ~4,963 Da), LAL endotoxin testing, cold-chain required — avoid pre-reconstituted forms.",
    },
    {
      type: "callout",
      text: "Bundled sourcing is logistically convenient, but researchers should verify that each compound's analytical documentation is independently certified — not pooled across compounds.",
    },
    {
      type: "heading",
