...
export const article: BlogArticle = {
  slug: "peptide-storage-complete-guide",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Most peptides are sensitive to UV light. Vials should be stored in original amber or opaque vials, in a dark storage area (refrigerator drawer, wrapped in foil), and away from laboratory UV lamps. Peptides containing tryptophan (Trp/W) residues are particularly photosensitive — this includes compounds like GHRP-2, GHRP-6, and Hexarelin. Extra light protection is warranted for these compounds.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Once a peptide is reconstituted in aqueous solution, stability decreases substantially regardless of storage conditions. Three core rules apply to all reconstituted peptides.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "Before using any stored peptide, inspect the solution carefully.",
    },
    {
      type: "subheading",
    ...
    },
    {
      type: "list",
      items: [
        "Cloudiness — indicates aggregation or contamination",
        "Visible particles — may indicate precipitation or contamination",
        "Unusual color change — oxidation or other chemical modification",
        "Strong or unusual odor — potential contamination",
      ],
    },
    {
      type: "subheading",
    ...
    },
    {
      type: "list",
      items: [
        "Very slight tint in solution (some peptides naturally produce this)",
    ...
    {
      type: "subheading",
      text: "For Small Research Operations",
    },
    {
      type: "list",
      items: [
        "A dedicated laboratory mini-refrigerator for 2–8°C storage prevents temperature fluctuations from frequently opened shared refrigerators",
        "A manual-defrost -20°C freezer prevents the temperature cycling of frost-free models",
    ...
    {
      type: "paragraph",
      text: "Every stored peptide vial should be labeled with: compound name and sequence/catalog ID, lot or batch number, date received, date reconstituted (if applicable), concentration (if reconstituted), and initials of the researcher responsible.",
    },
    {
      type: "heading",
      text: "Summary",
