...
export const article: BlogArticle = {
  ...
  description:
    "An evidence-based overview of semaglutide's GLP-1 receptor agonism mechanism, key clinical and preclinical research findings (STEP trials, SUSTAIN-6, rodent obesity models), neurological research interest, and sourcing criteria for researchers.",
  ...
  body: [
    ...
    {
      type: "callout",
      text: "It is important to distinguish between semaglutide studied as a research tool — to understand GLP-1 biology, metabolic pathways, and obesity mechanisms — and its regulated clinical applications. The published literature on semaglutide represents some of the highest-quality metabolic research available."
    },
    {
      type: "heading",
      text: "Summary"
