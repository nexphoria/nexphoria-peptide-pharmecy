...
export const article: BlogArticle = {
  slug: "peptide-storage-guide-jun21-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Key rules for lyophilized storage: Store in original sealed vial until use. Keep desiccant (silica gel) in storage container if vials are frequently accessed. Allow frozen vials to equilibrate to room temperature before opening — this prevents condensation moisture entry. Label with receipt date and compound identity.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "Most peptides are sensitive to UV light. Vials should be stored in original amber or opaque vials, in a dark storage area (refrigerator drawer, wrapped in foil), and away from laboratory UV lamps. Peptides containing tryptophan (Trp/W) residues are particularly photosensitive — this includes GHRP-2, GHRP-6, and Hexarelin. Extra light protection is warranted for these compounds.",
    },
    {
      type: "heading",
