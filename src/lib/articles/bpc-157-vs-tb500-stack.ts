...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: 'Nexphoria supplies both BPC-157 and TB-500 with full HPLC, MS, and COA documentation. Batch-specific testing data is available for both compounds, allowing researchers to document the quality of each component in a combined protocol independently.',
    },
    {
      type: 'callout',
      text: 'All compounds referenced are for pre-clinical research use only. Not for human use.',
    },
  ],
};
