...
export const article: BlogArticle = {
  slug: "nad-plus-sirtuins-parp-longevity-research-deep-dive",
  title: "NAD+: Sirtuins, PARP Competition, and the Science of Longevity Research",
  description: "A deep-dive research overview of NAD+ biology — why it declines with age, how it connects to sirtuin enzymes and PARP DNA repair, and what NMN vs NR precursor studies reveal about reversing aging hallmarks.",
  ...
  body: [
    ...
    {
      type: "callout",
      text: "The Competition Hypothesis: Accumulated DNA damage → PARP hyperactivation → NAD+ depletion → sirtuin suppression → accelerated aging hallmarks. This framework connects genomic instability, epigenetic alterations, and cellular senescence through a single metabolic bottleneck.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "NR is a precursor to NMN, then NAD+. It was the first to enter human trials; multiple published RCTs documenting blood NAD+ elevation (Trammell et al., Nature Communications, 2016). Commercially available; studied at doses of 250–1000 mg/day in human trials.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor and highly bioavailable, but high doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity applications specifically targeting sirtuin activation.",
    },
    {
      type: "subheading",
    ...
    {
      type: "heading",
      text: "Research Tools and Study Models",
    },
    {
      type: "list",
      items: [
