...
export const article: BlogArticle = {
  slug: "five-peptides-skeletal-muscle-repair-research-2026",
  title: "5 Research Peptides Used in Muscle Recovery Studies",
  description:
    "BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin have each been examined in preclinical skeletal muscle repair models. This evidence-based overview summarizes the mechanisms and study findings for each compound.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "All five peptides require rigorous quality verification for valid research: HPLC purity ≥99%, mass spectrometry identity confirmation, endotoxin-free certification (LAL testing), and cold-chain shipping and storage protocols.",
    },
    {
      type: "heading",
      text: "Summary",
