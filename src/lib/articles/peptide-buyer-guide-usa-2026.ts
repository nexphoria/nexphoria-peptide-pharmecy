...
export const article: BlogArticle = {
  slug: "peptide-buyer-guide-usa-2026",
  title: "How to Source Research Peptides in the USA: A 2026 Buyer's Guide",
  description:
    "A practical 2026 buyer's guide to sourcing research peptides in the USA — what HPLC certificates mean, why COAs matter, cold-chain requirements, red flags to avoid, and what sets premium suppliers apart.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A Certificate of Analysis (COA) is the primary documentation artifact accompanying a research peptide. A comprehensive COA should include: peptide identity confirmed by mass spectrometry; HPLC purity with accompanying chromatogram; molecular weight (observed vs. theoretical); endotoxin level via LAL test; lot/batch number traceable to your specific shipment; and testing date (recency matters — peptides degrade; old COAs may not reflect current lot).",
    },
    {
      type: "paragraph",
      text: "Third-party COAs from independent analytical laboratories are significantly more credible than in-house COAs performed by the seller. Suppliers who publish third-party COAs and make them accessible without requiring a purchase signal greater transparency and accountability.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Limulus Amebocyte Lysate (LAL) testing measures endotoxin contamination — bacterial lipopolysaccharide (LPS) and related pyrogens that can elicit severe inflammatory responses in in vivo models. Even small amounts of endotoxin (<1 EU/mL) can confound in vivo inflammatory studies, and IV or IP administration routes carry greater risk than SC for endotoxin-related artifacts.",
    },
    {
      type: "paragraph",
    ...
    },
    {
      ...
      items: [
        ...
        "Unusually low prices — synthesis corners are being cut",
      ],
    },
    {
      type: "heading",
