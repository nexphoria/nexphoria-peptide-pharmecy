...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: 'Before using any stored peptide, inspect the solution carefully. Discard if you observe cloudiness (indicates aggregation or contamination), visible particles (may indicate precipitation or contamination), unusual color change (oxidation or other chemical modification), or a strong/unusual odor (potential contamination). Very slight tints in solution and tiny air bubbles immediately after drawing are generally acceptable. When in doubt, discard — the cost of compromised experimental results significantly exceeds the cost of the peptide.',
    },
    {
      type: 'heading',
