...
export const article: BlogArticle = {
  slug: "peptide-storage-guide-temperature-light-shelf-life",
  ...
  body: [
    ...
    },
    {
      type: "list",
      items: [
        "Refrigerate immediately — Reconstituted peptides should be moved to 2–8°C storage as soon as reconstitution is complete. Room temperature storage of aqueous peptide solutions accelerates every degradation pathway simultaneously.",
        "Minimize freeze-thaw cycles — Freezing a reconstituted peptide and then thawing it is a significant degradation event. Ice crystal formation can mechanically disrupt peptide structure; each cycle adds cumulative damage.",
