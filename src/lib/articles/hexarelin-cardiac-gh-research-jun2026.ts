...
export const article: BlogArticle = {
  slug: "hexarelin-cardiac-gh-research-jun2026",
  title: "Hexarelin: Research on Cardiac and GH Applications",
  description:
    "A research overview of Hexarelin — a synthetic hexapeptide studied for growth hormone secretagogue activity and cardioprotective effects via the CD36 receptor pathway. What the published science shows.",
