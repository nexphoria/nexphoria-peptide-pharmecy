...
export const article: BlogArticle = {
  slug: "peptide-purity-hplc-testing-standards",
  title: "Why HPLC Purity Testing Matters When Sourcing Peptides",
  description:
    "Why HPLC purity testing is the gold standard for research peptides — what the method measures, why ≥99% purity matters for experimental validity, and how it integrates with mass spectrometry and LAL endotoxin testing.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The stationary phase is a nonpolar material (typically C18-bonded silica), and peptide components separate based on their relative hydrophobicity:",
    },
    {
      type: "list",
      items: [
        ...
        "Peak area corresponds to relative abundance in the sample",
      ],
    },
    {
      type: "paragraph",
      text: "A peptide with a single dominant peak at 99.3% area integration and minor impurity peaks totaling 0.7% would be reported as 99.3% pure.",
    },
    {
      type: "heading",
