...
export const article: BlogArticle = {
  slug: "peptide-purity-hplc-testing",
  title: "Why HPLC Purity Testing Matters When Sourcing Peptides",
  description:
    "HPLC purity testing is the gold standard for research peptides — but the numbers are only meaningful if you understand what they measure and what they don't. This article explains RP-HPLC, the 99% threshold, and how it integrates with mass spectrometry and LAL endotoxin testing.",
  ...
  body: [
    ...
    {
      type: "callout",
      text: "Consider a 10 mg/mL peptide solution at 95% HPLC purity. That preparation contains 0.5 mg/mL of unknown impurities — potentially including biologically active fragments with different receptor binding profiles. The 99% threshold exists specifically to reduce this variability to a level that is unlikely to materially affect experimental outcomes.",
    },
    {
      type: "heading",
