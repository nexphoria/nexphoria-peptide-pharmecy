...
export const article: BlogArticle = {
  slug: "semaglutide-research-peptide-glp1-studies",
  ...
  body: [
    ...
    {
      type: "callout",
      text: "Sourcing considerations: Sequence verification via mass spectrometry is essential — semaglutide's modified backbone requires confirmation of C18 fatty acid chain integrity. HPLC purity ≥99% should be verified from a COA. Endotoxin testing (LAL) is required for in vivo administration protocols. Proper cold-chain storage (2–8°C) is critical for maintaining biological activity.",
    },
    {
      type: "heading",
