...
export const article: BlogArticle = {
  slug: 'nexphoria-quality-standards-jun22-2026',
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: 'Every Nexphoria product is tested at ≥98% HPLC purity. The chromatogram for each specific batch is included in the batch COA — not an average or a representative example from a prior lot. A purity standard of 98% means that 98% or more of detected material is the target compound.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'A Certificate of Analysis is the primary quality document for a research compound. At Nexphoria, every COA includes the following fields:',
    },
    {
      type: 'table',
