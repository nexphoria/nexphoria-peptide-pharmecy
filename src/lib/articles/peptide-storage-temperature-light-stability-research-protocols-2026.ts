...
export const article: BlogArticle = {
  slug: "peptide-storage-temperature-light-stability-research-protocols-2026",
  title: "Proper Peptide Storage: Temperature, Light, and Shelf Life for Research (2026)",
  description:
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Most peptides are sensitive to UV light. Vials should be stored in original amber or opaque vials, dark storage areas (refrigerator drawer, wrapped in foil), and away from laboratory UV lamps. Peptides containing tryptophan (Trp/W) residues are particularly photosensitive — this includes GHRP-2, GHRP-6, and Hexarelin. Extra light protection is warranted for these compounds.",
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      items: [
        ...
        "Minimize freeze-thaw cycles: Ice crystal formation can mechanically disrupt peptide structure; each cycle adds cumulative damage",
        "Aliquot before long-term storage: Divide reconstituted peptide into single-use volumes to eliminate repeated freeze-thaw",
    ...
    },
    {
      ...
      items: [
        ...
        "Store peptides in sealed secondary containers with dessicant to minimize ambient moisture exposure",
      ],
    },
    {
      type: "subheading",
