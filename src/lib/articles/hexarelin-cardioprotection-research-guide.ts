...
export const article: BlogArticle = {
  ...
  description:
    "A research overview of Hexarelin — a synthetic hexapeptide studied for growth hormone secretagogue activity and cardioprotective effects through the CD36 receptor pathway. What the published science shows.",
