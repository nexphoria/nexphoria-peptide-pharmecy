...
export const article: BlogArticle = {
  slug: "bpc-157-vs-tb500-stack-combined-protocol-research",
  title: "BPC-157 + TB-500: Research on the Combined Protocol",
  description:
    "BPC-157 and TB-500 are mechanistically distinct but complementary tissue-repair peptides. This article examines the rationale for combined protocols, what the preclinical literature shows, and sourcing standards for both.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "To understand the rationale for combined research protocols, it helps to contrast each compound's primary mechanism. BPC-157 is a 15-amino acid peptide that operates through NO modulation, VEGF activation, and FAK-paxillin signaling. TB-500 is a 43-amino acid peptide whose primary mechanism is G-actin sequestration — directly facilitating cell migration through cytoskeletal remodeling.",
    },
    {
      type: "table",
    ...
    {
      type: "paragraph",
      text: "Direct studies using BPC-157 + TB-500 combinations in the same experimental design are limited in the published literature. Most available evidence comes from independent studies with overlapping models (allowing indirect comparison of effect sizes), mechanistic reasoning based on pathway maps suggesting no known antagonism, and observational data from research communities. The absence of direct head-to-head combined studies represents a gap in the literature.",
    },
    {
      type: "heading",
    ...
    },
    {
      type: "list",
      items: [
        "BPC-157 route: Subcutaneous or intraperitoneal",
        "BPC-157 dose: 10–100 µg/kg/day",
        "BPC-157 duration: 7–21 days, depending on injury model",
        "TB-500 route: Subcutaneous",
        "TB-500 dose: 200–500 µg/kg, 2–3x per week",
        "TB-500 duration: 3–6 weeks",
      ],
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "Researchers requiring both compounds for a combined protocol should apply uniform quality standards across both compounds:",
    },
    {
      type: "list",
      items: [
        "BPC-157: HPLC ≥99% purity with chromatogram required",
        "BPC-157: ESI-MS molecular weight confirmation",
        "TB-500: HPLC ≥99% purity — particularly critical for the 43-amino acid sequence with more potential truncation points",
        "TB-500: ESI-MS or MALDI-TOF confirmation — confirm MW: ~4,963 Da",
        "Both: LAL endotoxin testing (<1 EU/mg)",
        "Both: Lyophilized form; cold-chain shipping required",
      ],
    },
    {
      type: "callout",
      text: "Bundled sourcing is logistically convenient, but verify that each compound's analytical documentation is independently certified — not pooled into a single shared COA.",
    },
    {
      type: "heading",
