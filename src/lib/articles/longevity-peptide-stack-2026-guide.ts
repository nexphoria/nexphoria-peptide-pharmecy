...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Russia's two most studied nootropic peptides represent CNS-focused longevity components. Semax (ACTH 4-7 analog) provides BDNF upregulation, neuroprotection, and cognitive enhancement. Selank (tuftsin analog) delivers anxiolytic effects, BDNF upregulation, and immune modulation.",
    },
    {
      type: "paragraph",
