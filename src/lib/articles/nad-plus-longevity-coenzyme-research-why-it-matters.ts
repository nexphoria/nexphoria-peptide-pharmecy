...
export const article: BlogArticle = {
  slug: "nad-plus-longevity-coenzyme-research-why-it-matters",
  title: "NAD+: Why Longevity Researchers Are Paying Attention",
  description:
    "NAD+ sits at the convergence of energy metabolism, DNA repair, epigenetic regulation, and mitochondrial biology. This research overview explains the mechanism, the sirtuin connection, PARP competition, and what precursor data (NMN, NR, NAM) actually shows.",
  ...
  body: [
    ...
    {
      type: "subheading",
      text: "Drivers of Age-Related NAD+ Decline",
    },
    {
      type: "list",
      items: [
    ...
    {
      type: "paragraph",
      text: "The landmark 2013 paper by López-Otín et al. in Cell identified 9 hallmarks of aging. NAD+ biology intersects with at least five of them, explaining why it attracts sustained research investment as a potential modulator of core aging biology rather than a narrow intervention.",
    },
    {
      type: "table",
      headers: ["Hallmark", "NAD+ Connection"],
      rows: [
        ["Genomic instability", "PARP-1 dependent repair depletes NAD+"],
        ...
        ["Deregulated nutrient sensing", "SIRT1/SIRT3 in insulin/mTOR signaling"],
        ["Mitochondrial dysfunction", "SIRT3 mitochondrial protein deacetylation"],
      ],
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Because NAD+ itself has poor cellular uptake, research has focused on precursor molecules that the cell can convert to NAD+ via the salvage pathway. Three have been studied most extensively.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "NR is a precursor to NMN, then NAD+. It was the first to enter human trials and has multiple published RCTs documenting blood NAD+ elevation (Trammell et al., Nature Communications, 2016). Commercially available and studied at doses of 250–1000 mg/day in human trials.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor with high bioavailability, but high doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity applications where sirtuin activation is a primary goal.",
    },
    {
      type: "callout",
      text: "Key distinction: NMN has a more direct biosynthetic route but less published human RCT data; NR has more human trial evidence but requires an additional enzymatic step. Both elevate blood NAD+ effectively in human studies; tissue-specific distribution differences remain under investigation.",
    },
    {
      type: "heading",
      text: "Research Models Used in NAD+ Studies",
    },
    {
      type: "paragraph",
    ...
    {
      type: "disclaimer",
      text: "All content is for research and educational purposes only. NAD+ precursors and related compounds discussed here are studied in preclinical and clinical research contexts. Nothing in this article constitutes medical advice or a recommendation for human supplementation.",
    },
  ],
};
