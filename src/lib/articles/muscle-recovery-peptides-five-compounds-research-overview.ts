...
export const article: BlogArticle = {
  slug: "muscle-recovery-peptides-five-compounds-research-overview",
  title: "5 Research Peptides Used in Muscle Recovery Studies",
  description:
    "An evidence-based overview of five peptides — BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin — examined in preclinical muscle recovery and regeneration studies. Covers mechanism, key findings, and sourcing requirements.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "BPC-157 is thought to act via nitric oxide modulation and FAK-paxillin signaling, enhancing cell migration and angiogenesis critical to repair. Key reference: Sikiric et al. (multiple publications, University of Zagreb); Gwyer et al. systematic review (2019).",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "All five peptides require rigorous quality verification for reliable research outcomes:",
    },
    {
      type: "list",
      items: [
