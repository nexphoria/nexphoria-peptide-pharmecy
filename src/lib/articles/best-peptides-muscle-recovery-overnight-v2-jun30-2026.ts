...
export const article: BlogArticle = {
  ...
  body: [
    {
      type: 'paragraph',
      text: 'Skeletal muscle repair is a complex process involving satellite cell activation, myoblast proliferation, extracellular matrix remodeling, and re-innervation. These five peptides appear repeatedly in preclinical literature because they map to different parts of that repair cascade.',
    },
