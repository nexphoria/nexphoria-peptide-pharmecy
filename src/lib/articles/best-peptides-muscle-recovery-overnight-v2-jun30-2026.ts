...
export const article: BlogArticle = {
  slug: 'best-peptides-muscle-recovery-overnight-v2-jun30-2026',
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: 'Mechanistically, BPC-157 is thought to act via nitric oxide modulation and FAK-paxillin signaling, enhancing cell migration and angiogenesis critical to repair.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'IGF-1 LR3 binds the IGF-1 receptor and activates downstream anabolic signaling cascades. Its extended half-life compared to native IGF-1 makes it useful for studying sustained IGF-1R activation effects.',
    },
    {
      type: 'paragraph',
    ...
    },
    {
      type: 'list',
      items: [
        'Myostatin inhibition removes a brake on muscle hypertrophy',
        'Documented increases in muscle fiber diameter in murine models',
        'Follistatin gene therapy studies demonstrated large muscle mass increases in myostatin-null and follistatin-overexpressing mice',
        'Activin A inhibition contributes to muscle fiber size regulation',
      ],
    },
    {
      type: 'paragraph',
      text: 'By binding myostatin with high affinity, follistatin prevents ActRIIB signaling and disinhibits muscle growth pathways including Akt/mTOR and satellite cell activation.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Ipamorelin mimics ghrelin\'s action at the GHSR-1a receptor in the hypothalamus and pituitary, triggering GH secretion. Its selectivity profile makes it useful for isolated study of GH pulse effects without the confound of elevated stress hormones.',
    },
    {
      type: 'heading',
