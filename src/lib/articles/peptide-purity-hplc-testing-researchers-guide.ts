...
export const article: BlogArticle = {
  ...
  description:
    'HPLC purity testing is the gold standard for research peptides — but understanding what the numbers actually measure is essential. This guide explains RP-HPLC, why ≥99% purity matters for experimental validity, what HPLC cannot confirm, and how it integrates with mass spectrometry and LAL endotoxin testing.',
  ...
  body: [
    ...
    },
    {
      ...
      items: [
        ...
        'The relative area of each peak corresponds to the relative abundance of that component in the sample',
      ],
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'HPLC purity testing has important blind spots that researchers should understand before relying on it as a sole quality indicator.',
    },
    {
      type: 'subheading',
