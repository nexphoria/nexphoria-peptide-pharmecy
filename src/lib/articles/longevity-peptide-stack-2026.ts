...
export const article: BlogArticle = {
  ...
  description:
    "A research-oriented overview of the peptide combinations longevity scientists are investigating in 2026. Covers GH axis restoration, telomere biology, tissue repair, mitochondrial targets, and neurological maintenance — grounded in the hallmarks-of-aging framework.",
  ...
  body: [
    ...
    {
      type: "callout",
      text: "No single compound addresses all aging hallmarks. The research case for combination protocols (stacks) rests on targeting multiple hallmarks simultaneously — with compounds that are complementary rather than redundant."
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "MOTS-c is a mitochondria-derived peptide (MDP) encoded within the mitochondrial 12S rRNA. Research findings include insulin sensitization with reversal of diet-induced insulin resistance in mouse models, exercise-mimetic effects via activation of AMPK and related metabolic sensors, lifespan extension demonstrated in C. elegans, and age-dependent decline in circulating MOTS-c levels — suggesting it as both a biomarker and potential intervention target."
    },
    {
      type: "subheading",
      text: "Humanin"
    ...
    {
      type: "paragraph",
      text: "Humanin is another mitochondria-derived peptide with documented roles in neuroprotection (originally identified in Alzheimer's disease context), cardiovascular protection, metabolic regulation, and age-related decline in circulating levels. Humanin and MOTS-c are increasingly studied together as a mitochondria-derived peptide combination targeting multiple aspects of mitochondrial decline."
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Russia's two most studied nootropic peptides represent CNS-focused longevity components. Semax (ACTH 4-7 analog) demonstrates BDNF upregulation, neuroprotection, and cognitive enhancement in preclinical models. Selank (tuftsin analog) demonstrates anxiolytic activity, BDNF upregulation, and immune modulation. In longevity research, neurological aging — including cognitive decline, neuroinflammation, and HPA axis dysregulation — is an understudied target relative to metabolic and cardiovascular aging."
    },
    {
      type: "heading",
