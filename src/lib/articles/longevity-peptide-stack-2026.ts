...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "MOTS-c is a mitochondria-derived peptide (MDP) encoded within the mitochondrial 12S rRNA. Research findings include insulin sensitization (reversal of diet-induced insulin resistance in mouse models), exercise-mimetic effects (activation of AMPK and related metabolic sensors), and lifespan extension demonstrated in C. elegans. Age-dependent decline in MOTS-c levels suggests it as both a biomarker and potential intervention target. Research focus in 2026: interaction with NAD+ metabolism; combination with GLP-1 receptor research; tissue distribution studies.",
    },
    {
      type: "subheading",
      text: "Humanin",
    ...
    {
      type: "paragraph",
      text: "Humanin is another MDP — one of the first identified — with documented roles in neuroprotection (originally identified in Alzheimer's disease context), cardiovascular protection, metabolic regulation, and age-related circulating level decline. Humanin and MOTS-c are increasingly studied together as a mitochondria-derived peptide combination targeting multiple aspects of mitochondrial decline.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Most longevity data remains in animal models. Human longevity trials are long-duration by necessity; reliable human data for most peptides is limited. Combination effects are largely unstudied — most compounds have been researched individually; interaction effects in stacks are not well characterized. IGF-1 elevation has a complex relationship with longevity: higher IGF-1 is associated with improved function in some contexts and increased cancer risk in others. Regulatory status varies by jurisdiction; researchers must operate within applicable regulatory frameworks.",
    },
    {
      type: "heading",
      text: "Summary",
