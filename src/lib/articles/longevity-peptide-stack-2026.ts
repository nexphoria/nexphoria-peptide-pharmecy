...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: "Russia's two most studied nootropic peptides represent CNS-focused longevity components. Semax (ACTH 4-7 analog) features BDNF upregulation, neuroprotection, and cognitive enhancement. Selank (tuftsin analog) features anxiolytic properties, BDNF upregulation, and immune modulation. In longevity research, neurological aging — including cognitive decline, neuroinflammation, and HPA axis dysregulation — is an understudied target relative to metabolic and cardiovascular aging. Neuropeptide research addresses this gap.",
    },
    {
      type: 'heading',
