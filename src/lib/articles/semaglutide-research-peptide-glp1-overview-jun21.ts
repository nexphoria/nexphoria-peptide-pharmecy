...
export const article: BlogArticle = {
  slug: "semaglutide-research-peptide-glp1-overview-jun21",
  title: "Semaglutide as a Research Peptide: What the Published Studies Show",
  description:
    "Semaglutide is a GLP-1 receptor agonist with one of the largest published research datasets in metabolic biology. This overview covers its mechanism, key clinical trial data, preclinical obesity models, and neurological research interest.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "GLP-1 (glucagon-like peptide-1) is an incretin hormone naturally secreted by L-cells in the small intestine in response to nutrient ingestion. Its primary physiological roles include:",
    },
    {
      type: "list",
      items: [
    ...
    {
      type: "paragraph",
      text: "In rodent obesity models (diet-induced obesity; DIO mice), semaglutide demonstrated:",
    },
    {
      type: "list",
      items: [
        "Dose-dependent reductions in body fat mass",
        "Improved insulin sensitivity (HOMA-IR markers)",
        "Reduced hepatic steatosis in high-fat diet models",
        "Preservation of lean body mass relative to fat loss",
      ],
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "An emerging area of semaglutide research involves CNS effects. GLP-1 receptors are expressed in the brain, including the hippocampus and dopaminergic circuits. Preclinical studies have examined:",
    },
    {
      type: "list",
      items: [
        "Neuroinflammation reduction in Alzheimer's disease models",
        "Dopamine signaling and potential applications in addiction models",
        "Appetite regulation via arcuate nucleus and nucleus accumbens pathways",
      ],
    },
    {
      type: "paragraph",
    ...
    {
      type: "subheading",
      text: "Critical Sourcing Considerations for Researchers",
    },
    {
      type: "list",
      items: [
        ...
        "HPLC purity ≥99% should be verified from a lot-specific COA",
