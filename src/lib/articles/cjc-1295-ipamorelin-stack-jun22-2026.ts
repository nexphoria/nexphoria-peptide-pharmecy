...
export const article: BlogArticle = {
  slug: "cjc-1295-ipamorelin-stack-jun22-2026",
  ...
  body: [
    ...
    },
    {
      type: "list",
      items: [
        "Amplified GH pulse response: Studies examining co-administration of GHRH analogs with GHS compounds consistently show greater GH output than either compound alone — consistent with synergistic rather than additive interaction",
        "Somatostatin suppression: GHS-R1a agonism suppresses somatostatin tone, reducing the inhibitory brake on GH release and further augmenting the response to concurrent GHRH stimulation",
        "Pulsatility preservation: Unlike exogenous GH, the combination maintains natural pulsatile release patterns",
      ],
    },
    {
      type: "heading",
