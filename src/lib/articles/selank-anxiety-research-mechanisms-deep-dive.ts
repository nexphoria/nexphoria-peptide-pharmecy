...
export const article: BlogArticle = {
  slug: "selank-anxiety-research-mechanisms-deep-dive",
  title: "Selank: The Russian Peptide Studied for Anxiety — Mechanisms Deep Dive",
  description:
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Beyond anxiolytic activity, Selank has been studied for cognitive enhancement properties including memory consolidation (animal studies report improved performance on learning and memory tasks), attention and mental clarity (clinical observations describe reduced cognitive fatigue without stimulant-like effects), and neuroprotective properties (some research documents protection against oxidative stress-induced neuronal damage in cell culture models).",
    },
    {
      type: "subheading",
