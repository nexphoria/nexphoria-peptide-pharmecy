...
export const aOVN_V2_HPLC_PURITY: BlogArticle = {
  slug: 'why-hplc-purity-testing-matters-peptide-sourcing-ovn-v2',
  title: 'Why HPLC Purity Testing Matters When Sourcing Peptides',
  description:
    'HPLC purity testing is the gold standard for research peptides. This guide explains what the method measures, why ≥99% purity matters for experimental validity, and how it integrates with mass spectrometry and LAL endotoxin testing.',
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: 'In the context of peptide analysis, reverse-phase HPLC (RP-HPLC) is the standard method. The stationary phase is a nonpolar material (typically C18-bonded silica), and peptide components separate based on their relative hydrophobicity.',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Here is how a research-grade peptide purity assessment is typically conducted:',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'HPLC purity testing has important blind spots that researchers should understand.',
    },
    {
      type: 'subheading',
    ...
    {
      type: 'paragraph',
      text: 'HPLC with UV detection does not detect endotoxins (bacterial lipopolysaccharide), residual solvents below detection threshold, or some inorganic synthesis contaminants. This is why LAL testing and residual solvent analysis are separate required tests.',
    },
    {
      type: 'subheading',
    ...
    },
    {
      type: 'list',
      items: [
        '<1 EU/mg is standard for research-grade material',
        '<0.1 EU/mg is expected for preparations intended for IV or IP administration protocols',
      ],
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'When reviewing a certificate of analysis, look for the following fields:',
    },
    {
      type: 'table',
