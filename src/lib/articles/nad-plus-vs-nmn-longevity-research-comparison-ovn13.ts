...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-longevity-research-comparison-ovn13",
  ...
  body: [
    ...
    },
    {
      ...
      items: [
        ...
        "Stable formulation at room temperature",
        "Dedicated intestinal transporter (Slc12a8) identified",
      ],
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape shows NMN favored for its direct precursor pathway and emerging human data — often combined with resveratrol or pterostilbene as SIRT1 activators, though evidence for synergy remains preliminary. NR benefits from a more extensive human clinical trial base, published safety and tolerability data across multiple studies, and easier formulation stability.",
    },
    {
      type: "paragraph",
      text: "Notable active research directions include tissue-specific delivery (some researchers are investigating whether different precursors preferentially elevate NAD+ in different tissues — liver vs. muscle vs. brain), NAMPT activators (compounds that upregulate the enzyme limiting NAD+ biosynthesis from nicotinamide, potentially more efficient than precursor loading), and CD38 inhibitors (CD38 is a major NAD+-consuming enzyme; reducing its activity may be as effective as increasing NAD+ supply).",
    },
    {
      type: "heading",
