...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-longevity-researchers-jun20-2026",
  ...
  body: [
    ...
    },
    {
      ...
      items: [
        ...
        "A 2020 human pilot study (Yoshino et al.) showed oral NMN supplementation raised blood NAD+ metabolite levels and improved insulin sensitivity in prediabetic women",
    ...
    },
    {
      type: "list",
      items: [
        "Multiple human trials showing NR raises whole-blood NAD+ levels",
    ...
    {
      type: "paragraph",
      text: "Oral NAD+ faces a significant bioavailability problem — most ingested NAD+ is cleaved in the gut to nicotinamide before absorption. IV NAD+ infusion bypasses this limitation and is used in clinical research contexts. Subcutaneous and intranasal NAD+ delivery are also under investigation, with some pre-clinical data suggesting improved bioavailability over oral routes.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape suggests different strengths for each approach.",
    },
    {
      type: "subheading",
    ...
    },
    {
      type: "list",
      items: [
        "More direct pathway to NAD+",
        "Emerging human data supports systemic NAD+ elevation",
        "Interest in combining NMN with resveratrol or pterostilbene as SIRT1 activators",
      ],
    },
    {
      type: "subheading",
