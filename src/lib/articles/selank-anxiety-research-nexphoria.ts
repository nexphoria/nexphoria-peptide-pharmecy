...
export const article: BlogArticle = {
  slug: "selank-anxiety-research-nexphoria",
  title: "Selank: The Russian Peptide Studied for Anxiety",
  description:
    "An evidence-based overview of Selank, the heptapeptide developed in Russia and studied for anxiolytic and nootropic effects. Research findings, mechanisms, and what the published data shows.",
  ...
  body: [
    ...
    {
      type: "subheading",
      text: "Stability and Purity Requirements",
    },
    {
      type: "paragraph",
