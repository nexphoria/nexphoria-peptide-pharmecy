...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: 'Humanin is another MDP — one of the first identified — with documented roles in neuroprotection (originally in Alzheimer\'s disease context), cardiovascular protection, metabolic regulation, and age-related decline. Humanin and MOTS-c are increasingly studied together as a mitochondria-derived peptide combination targeting multiple aspects of mitochondrial decline.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'Russia\'s two most studied nootropic peptides represent CNS-focused longevity components. Semax (ACTH 4-7 analog) has been documented for BDNF upregulation, neuroprotection, and cognitive enhancement. Selank (tuftsin analog) shows anxiolytic properties, BDNF upregulation, and immune modulation. In longevity research, neurological aging — including cognitive decline, neuroinflammation, and HPA axis dysregulation — is an understudied target relative to metabolic and cardiovascular aging.',
    },
    {
      type: 'heading',
