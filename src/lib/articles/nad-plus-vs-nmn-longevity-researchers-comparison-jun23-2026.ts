...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-longevity-researchers-comparison",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Oral NAD+ faces a significant bioavailability problem — most ingested NAD+ is cleaved in the gut to nicotinamide before absorption. IV NAD+ infusion bypasses this limitation and is used in clinical research contexts, examining effects on neurological function, addiction recovery applications (early research, limited evidence), and acute elevation of tissue NAD+ levels. Subcutaneous and intranasal NAD+ delivery are also under investigation, with some pre-clinical data suggesting improved bioavailability over oral routes.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape suggests divergent priorities:",
    },
    {
      type: "subheading",
    ...
    },
    {
      type: "list",
      items: [
        "More direct biosynthetic pathway",
