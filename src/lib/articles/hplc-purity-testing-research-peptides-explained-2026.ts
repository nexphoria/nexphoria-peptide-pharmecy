...
export const article: BlogArticle = {
  slug: "hplc-purity-testing-research-peptides-explained-2026",
  title: "HPLC Purity Testing Explained: What Every Peptide Researcher Needs to Know",
  description:
    "A technical breakdown of reverse-phase HPLC purity testing for research peptides — what the method measures, why ≥99% matters for experimental validity, how mass spectrometry and LAL endotoxin testing complement it, and how to read a COA critically.",
  ...
  body: [
    ...
    },
    {
      type: "list",
      items: [
        "Sample preparation — peptide dissolved in defined solvent (often 0.1% TFA in water/acetonitrile)",
    ...
    {
      type: "heading",
      text: "Mass Spectrometry: The Essential Complement",
    },
    {
      type: "paragraph",
