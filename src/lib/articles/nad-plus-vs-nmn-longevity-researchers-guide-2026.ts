...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape suggests NMN has a more direct pathway and emerging human data supports systemic NAD+ elevation; NR has a more extensive human clinical trial base and published safety and tolerability data across multiple studies.",
    },
    {
      type: "paragraph",
      text: "Notable research directions include tissue-specific delivery — investigating whether different precursors preferentially elevate NAD+ in different tissues (e.g., liver vs. muscle vs. brain) — as well as NAMPT activators and CD38 inhibitors. CD38 is a major NAD+-consuming enzyme; reducing its activity may be as effective as increasing NAD+ supply.",
    },
    {
      type: "heading",
