...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Oral NAD+ faces a significant bioavailability problem. Research suggests most ingested NAD+ is cleaved in the gut to nicotinamide before absorption. IV NAD+ infusion bypasses this limitation and is used in clinical research contexts, examining effects on neurological function, addiction recovery applications, and acute elevation of tissue NAD+ levels. Subcutaneous and intranasal NAD+ delivery are also under investigation, with some pre-clinical data suggesting improved bioavailability over oral routes.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape reflects ongoing debate between NMN (more direct pathway, emerging human data, growing interest in combination with SIRT1 activators such as resveratrol or pterostilbene) and NR (more extensive human clinical trial base, published safety and tolerability data across multiple studies). Notable research directions include tissue-specific delivery, where some researchers investigate whether different precursors preferentially elevate NAD+ in different tissues; NAMPT activators that upregulate the enzyme limiting NAD+ biosynthesis from nicotinamide; and CD38 inhibitors, as CD38 is a major NAD+-consuming enzyme and reducing its activity may be as effective as increasing NAD+ supply.",
    },
    {
      type: "heading",
