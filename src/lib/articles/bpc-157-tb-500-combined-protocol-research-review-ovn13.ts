...
export const article: BlogArticle = {
  slug: "bpc-157-tb-500-combined-protocol-research-review-ovn13",
  title: "BPC-157 + TB-500: Research on the Combined Protocol",
  description:
    "An in-depth look at the mechanistic rationale for combining BPC-157 and TB-500 in preclinical tissue repair research. What the available literature shows about complementary pathways, protocol design, and sourcing requirements.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "In preclinical models, combined BPC-157 + TB-500 protocols use the following frameworks:",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "Researchers requiring both compounds for a combined protocol should apply uniform quality standards across both. For BPC-157: HPLC ≥99% purity (chromatogram required), ESI-MS molecular weight confirmation, LAL endotoxin testing (<1 EU/mg), lyophilized form with cold-chain shipping. For TB-500: HPLC ≥99% purity is particularly important for the 43-amino acid sequence which has more potential truncation points; ESI-MS or MALDI-TOF confirmation (confirm MW: ~4,963 Da); LAL endotoxin testing; cold-chain required; avoid pre-reconstituted forms from suppliers.",
    },
    {
      type: "callout",
      text: "Bundled sourcing tip: Some research suppliers offer BPC-157 and TB-500 together with shared COA documentation. This is logistically convenient, but verify that each compound's analytical documentation is independently certified — not pooled.",
    },
    {
      type: "heading",
