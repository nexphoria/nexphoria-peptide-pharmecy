...
export const article: BlogArticle = {
  slug: "nad-plus-longevity-sirtuins-parp-research-jun20-2026",
  title: "NAD+: Why Longevity Researchers Are Paying Attention",
  description: "NAD+ is central to longevity research — sirtuins, PARP repair, and the hallmarks of aging. An evidence-based overview of why researchers study NAD+ precursors and how NMN, NR, and NAM compare.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The landmark 2013 paper by López-Otín et al. in Cell identified 9 hallmarks of aging. NAD+ biology intersects with at least five of them. This breadth of mechanistic connection is a key reason NAD+ has attracted sustained research attention — it is not a narrow intervention but a potential modulator of core aging biology.",
    },
    {
      type: "table",
    ...
    {
      type: "paragraph",
      text: "NR is a precursor to NMN, then NAD+. It was the first to enter human trials, with multiple published RCTs documenting blood NAD+ elevation (Trammell et al., Nature Communications, 2016). Commercially available and studied at doses of 250–1000 mg/day in human trials.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor and is highly bioavailable. However, high doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity applications. NMN has a more direct biosynthetic route but lower current volume of human clinical data. NR has more published human RCT data but requires an additional enzymatic step. Both elevate blood NAD+ effectively; tissue-specific distribution differences remain under investigation.",
    },
    {
      type: "heading",
