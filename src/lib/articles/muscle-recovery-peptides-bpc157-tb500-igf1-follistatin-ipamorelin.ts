...
export const article: BlogArticle = {
  slug: "muscle-recovery-peptides-bpc157-tb500-igf1-follistatin-ipamorelin",
  title: "5 Research Peptides Used in Muscle Recovery Studies: BPC-157, TB-500, IGF-1 LR3, Follistatin-344 & Ipamorelin",
  description:
    "An evidence-based overview of five peptides — BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin — that appear frequently in preclinical muscle recovery and regeneration research, with mechanisms, key findings, and comparative overview.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "All five peptides require rigorous quality verification for valid research use. Minimum standards include HPLC purity ≥99%, mass spectrometry identity confirmation, endotoxin-free certification via LAL testing, and cold-chain shipping and storage protocols. Lot-specific COAs from independent laboratories are essential.",
    },
    {
      type: "heading",
      text: "Summary",
