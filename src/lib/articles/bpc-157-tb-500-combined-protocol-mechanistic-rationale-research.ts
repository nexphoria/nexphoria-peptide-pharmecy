...
export const article: BlogArticle = {
  slug: "bpc-157-tb-500-combined-protocol-mechanistic-rationale-research",
  title: "BPC-157 + TB-500: The Combined Protocol — Mechanistic Rationale and Research Overview",
  description: "BPC-157 and TB-500 are frequently studied together in preclinical research. This article examines the mechanistic rationale for combined protocols, what the available literature shows, and key considerations for researchers sourcing both compounds.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "To understand the rationale for combined research protocols, it helps to contrast each compound's primary mechanism. BPC-157 is a 15-amino acid peptide primarily acting through NO modulation, VEGF, and FAK-paxillin signaling, with strong angiogenic effects and documented activity across GI, tendon, muscle, and CNS models. TB-500 is a 43-amino acid peptide acting through G-actin sequestration and VEGF, with direct effects on cellular migration and activity across skin, cardiac, muscle, and tendon models.",
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "In preclinical models, combined BPC-157 + TB-500 protocols typically use the following ranges. For BPC-157 in rodent models: subcutaneous or intraperitoneal route, 10–100 µg/kg/day, 7–21 day duration depending on injury model. For TB-500 in rodent models: subcutaneous route, 200–500 µg/kg administered 2–3 times per week, over 3–6 weeks.",
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "Researchers requiring both compounds for a combined protocol should apply uniform quality standards across both. For BPC-157: HPLC ≥99% purity with chromatogram required, ESI-MS molecular weight confirmation, LAL endotoxin testing (<1 EU/mg), lyophilized form with cold-chain shipping. For TB-500: HPLC ≥99% purity is particularly important for the 43-amino acid sequence which has more potential truncation points; ESI-MS or MALDI-TOF confirmation to confirm MW of approximately 4,963 Da; LAL endotoxin testing; cold-chain required with pre-reconstituted forms from suppliers avoided.",
    },
    {
      type: "callout",
    ...
    {
      type: "paragraph",
      text: "When running a combined BPC-157 + TB-500 protocol, experimental variables to track include histological markers of tissue repair (H&E, Masson's trichrome for collagen), angiogenesis markers (CD31 immunostaining), inflammatory markers (IL-6, TNF-α, neutrophil/macrophage infiltration), and functional recovery metrics where motor or mechanical testing applies.",
    },
    {
      type: "list",
      items: [
        "Control conditions: vehicle-only, BPC-157 alone, TB-500 alone, combined — to isolate additive vs. synergistic effects",
        "Histological analysis at matched timepoints across all groups",
        "Blinded tissue scoring to reduce observer bias",
        "Statistical power calculation prior to group size selection",
      ],
    },
    {
      type: "heading",
