...
export const article: BlogArticle = {
  slug: "selank-anxiety-research-peptide-overview",
  title: "Selank: The Russian Peptide Studied for Anxiety and Cognitive Enhancement",
  description:
    "An evidence-based overview of Selank — the heptapeptide developed in Russia and studied for anxiolytic and nootropic effects. Covers mechanism of action, published research findings, comparison to related compounds, and research considerations.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Beyond anxiolytic activity, Selank has been studied for cognitive enhancement properties. Animal studies report improved performance on learning and memory tasks (memory consolidation). Clinical observations in Russian studies describe reduced cognitive fatigue without stimulant-like effects. Some research documents protection against oxidative stress-induced neuronal damage in cell culture models.",
    },
    {
      type: "subheading",
