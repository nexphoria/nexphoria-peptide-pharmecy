...
export const article: BlogArticle = {
  slug: "semaglutide-glp1-metabolic-obesity-research-overview",
  title: "Semaglutide as a Research Peptide: What the Published Studies Show",
  description:
    "Semaglutide as a research tool — GLP-1 receptor agonism, STEP trial findings, preclinical obesity models, cardiovascular and neurological research, and quality considerations for research-grade sourcing.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Semaglutide binds with high affinity to the GLP-1 receptor (GLP-1R), a G-protein coupled receptor (GPCR) expressed throughout the body: in the pancreas for insulin secretion and beta-cell preservation; in the hypothalamus for satiety signaling; in the liver for suppression of hepatic glucose output; in the GI tract to slow gastric emptying; and in the cardiovascular system where anti-inflammatory and cardioprotective effects are under study.",
    },
    {
      type: "paragraph",
    ...
    {
      type: "subheading",
      text: "Quality Considerations for Research-Grade Sourcing",
    },
    {
      type: "list",
      items: [
