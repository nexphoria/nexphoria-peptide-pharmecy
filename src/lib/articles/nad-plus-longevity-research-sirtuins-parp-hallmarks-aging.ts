...
export const article: BlogArticle = {
  ...
  title: "NAD+ in Longevity Research: Sirtuins, PARP Biology, and the Hallmarks of Aging",
  description:
    "Why NAD+ has become a central target in longevity research — its role in sirtuin activation, PARP-mediated DNA repair, age-related decline mechanisms, and how NAD+ precursors NMN, NR, and NAM compare in current preclinical and clinical literature.",
  category: "Longevity",
  readMinutes: 11,
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The landmark 2013 paper by López-Otín et al. in Cell identified 9 hallmarks of aging. NAD+ biology intersects with at least five of them, making it one of the most mechanistically justified targets in aging research.",
    },
    {
      type: "table",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor, highly bioavailable. However, high doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity-focused applications where sirtuin activation is a primary research goal.",
    },
    {
      type: "callout",
