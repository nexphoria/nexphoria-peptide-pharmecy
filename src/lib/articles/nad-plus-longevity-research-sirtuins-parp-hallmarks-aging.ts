...
export const article: BlogArticle = {
  ...
  title: "NAD+: Why Longevity Researchers Are Paying Attention — Sirtuins, PARP, and the Hallmarks of Aging",
  description:
    "NAD+ sits at the intersection of energy metabolism, DNA repair, and epigenetic regulation. This research overview covers why NAD+ declines with age, its role in sirtuin and PARP biology, and how NMN and NR compare as research tools.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "NAD+ exists in oxidized (NAD+) and reduced (NADH) forms, cycling between them as it shuttles electrons during metabolic processes. It is essential for glycolysis and the TCA cycle (core ATP production pathways), sirtuin activation — the NAD+-dependent deacetylase enzymes central to aging research — PARP-1 activity for DNA damage repair, and CD38 signaling involved in immune regulation.",
    },
    {
      type: "callout",
      text: "The critical issue identified in aging research: NAD+ levels decline 40–60% between young adulthood and middle age in rodents and humans, with further decline into senescence.",
    },
    {
      type: "paragraph",
      text: "The drivers of this decline appear to be multifactorial: decreased biosynthesis via the salvage pathway (NAMPT activity declines with age), increased consumption by PARP enzymes in response to cumulative DNA damage, and elevated CD38 expression in aged tissues, which degrades NAD+.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "This breadth of mechanistic connection explains why NAD+ has attracted sustained research attention — it is not a narrow intervention but a potential modulator of core aging biology.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "NR is a precursor to NMN, then NAD+. It was first to enter human trials, with multiple published RCTs documenting blood NAD+ elevation (Trammell et al., Nature Communications, 2016). Commercially available; studied at doses of 250–1000 mg/day in human trials.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor with high bioavailability, but high doses can inhibit sirtuins by product feedback inhibition — a potential limitation specifically for longevity applications where sirtuin activation is a research goal.",
    },
    {
      type: "callout",
      text: "Key distinction: NMN has a more direct biosynthetic route but less current human clinical data. NR has more published human RCT data but requires an additional enzymatic step. Both elevate blood NAD+ effectively; tissue-specific distribution differences remain under investigation.",
    },
    {
      type: "heading",
