...
export const article: BlogArticle = {
  ...
  title: "Epithalon and Telomere Research: What Studies Actually Show",
  description:
    "An evidence-based review of Epithalon (Epitalon), the tetrapeptide studied for telomere elongation and longevity. Covers the Khavinson research program, in vitro and animal data, what is and isn't established, and how it compares to other telomere-targeting compounds.",
  ...
  body: [
    ...
    },
    {
      ...
      items: [
        ...
        "Purity requirements: As a tetrapeptide, HPLC ≥98% purity and sequence fidelity verification remain critical",
