...
export const article: BlogArticle = {
  slug: "longevity-peptide-stack-2026-complete-research-framework",
  title: "The 2026 Longevity Peptide Stack: Complete Research Framework",
  description:
    "A research-oriented overview of the peptide combinations longevity scientists are investigating in 2026. Covers GH axis, telomere biology, tissue repair, mitochondrial targets, and neurological maintenance with a full hallmarks-of-aging framework.",
