...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "callout",
      text: "Bundled sourcing tip: Some research suppliers offer BPC-157 and TB-500 together with shared COA documentation. Verify that each compound's analytical documentation is independently certified — not pooled.",
    },
    {
      type: "heading",
