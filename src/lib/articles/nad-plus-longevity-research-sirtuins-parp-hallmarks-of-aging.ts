...
export const article: BlogArticle = {
  slug: "nad-plus-longevity-research-sirtuins-parp-hallmarks-of-aging",
  ...
  body: [
    ...
    {
      type: "callout",
      text: "The competition hypothesis: accumulated DNA damage → PARP hyperactivation → NAD+ depletion → sirtuin suppression → accelerated aging hallmarks.",
    },
    {
      type: "paragraph",
      text: "This has important implications for understanding the connection between genomic instability (Hallmark #1 of aging per López-Otín et al.), epigenetic alterations (Hallmark #4), and cellular senescence (Hallmark #7).",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor with high bioavailability. High doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity applications.",
    },
    {
      type: "callout",
