...
export const article: BlogArticle = {
  slug: "why-hplc-purity-testing-matters-peptide-sourcing-jun20-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A research-grade peptide purity assessment is typically conducted through the following steps:",
    },
    {
      type: "list",
      items: [
