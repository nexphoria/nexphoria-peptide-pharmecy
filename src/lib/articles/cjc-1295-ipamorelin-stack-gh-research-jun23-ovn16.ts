...
export const article: BlogArticle = {
  slug: "cjc-1295-ipamorelin-stack-gh-research-jun23-ovn16",
  title: "CJC-1295 + Ipamorelin: Growth Hormone Research Stack",
  description:
    "A research-focused overview of the CJC-1295 and Ipamorelin combination — mechanisms, published data, and what the science says about this dual-pathway growth hormone secretagogue stack.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "This article summarizes the mechanisms of each peptide, the rationale for combining them, and what published research has documented.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "A 2006 study published in the Journal of Clinical Endocrinology & Metabolism (Teichman et al.) administered CJC-1295 to healthy adult subjects. Key observations included dose-dependent increases in plasma GH — up to 10-fold above baseline in some subjects — sustained IGF-1 elevation lasting 9–11 days after a single dose, and preservation of pulsatile GH release. CJC-1295 appeared to amplify rather than replace endogenous GH secretion rhythms, which is a notable distinction from exogenous GH administration that typically suppresses endogenous production.",
    },
    {
      type: "table",
    ...
    {
      type: "paragraph",
      text: "Research on Ipamorelin, primarily in animal models, has documented robust GH pulse stimulation comparable to GHRP-6 at equivalent molar doses, reduced off-target hormone release, and potential effects on gastric motility — a property under investigation in gastrointestinal research contexts. A study by Elbrønd et al. (1999) in swine demonstrated significant, dose-dependent GH release with Ipamorelin, with a favorable selectivity profile compared to GHRP-2.",
    },
    {
      type: "table",
      headers: ["Parameter", "Value"],
    ...
    {
      type: "callout",
      text: "The following reflects protocols described in research literature only. These figures are not clinical recommendations and are provided for reference purposes.",
    },
    {
      type: "table",
    ...
    },
    {
      ...
      items: [
        ...
        "Optimal timing relationships between the two compounds require further study",
      ],
    },
    {
      type: "heading",
    ...
    {
      type: "disclaimer",
      text: "This content is intended for qualified researchers only. CJC-1295 and Ipamorelin are sold exclusively for in vitro and pre-clinical research use. They are not approved for human administration, clinical use, or therapeutic application.",
    },
  ],
};
