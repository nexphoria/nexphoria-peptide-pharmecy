...
export const article: BlogArticle = {
  slug: "peptide-purity-hplc-testing-coa-guide-ovn25",
  title: "Why HPLC Purity Testing Matters When Sourcing Peptides",
  description:
    "HPLC purity testing is the gold standard for research peptides — but the numbers only matter if you understand what they measure. A deep-dive on what ≥99% purity means, how HPLC works, its limitations, and why mass spec and LAL testing complete the picture.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "When reviewing a certificate of analysis, verify: HPLC purity ≥99% with an included chromatogram; retention time listed and consistent with peptide properties; MS data showing observed MW matching theoretical ±0.5 Da; endotoxin (LAL) result in EU/mg (not just 'pass'); lot number matching your shipment; test date within 6 months; and a third-party testing lab preferred over in-house.",
    },
    {
      type: "heading",
      text: "Summary",
