...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A Certificate of Analysis is the primary quality document for a research compound. At Nexphoria, every COA is batch-specific — not a generic template — and includes the following fields:"
    },
    {
      type: "table",
