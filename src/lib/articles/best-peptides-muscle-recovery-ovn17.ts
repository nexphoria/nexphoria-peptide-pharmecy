...
export const article: BlogArticle = {
  slug: "best-peptides-muscle-recovery-ovn17",
  title: "5 Research Peptides Used in Muscle Recovery Studies",
  description:
    "BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin have been examined in muscle recovery and regeneration studies. An evidence-based overview of the preclinical research for each.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Mechanism: By binding myostatin with high affinity, follistatin prevents myostatin from activating its receptor (ActRIIB), thereby disinhibiting muscle growth pathways including Akt/mTOR and satellite cell activation. Follistatin-344 research has clinical relevance to conditions involving muscle wasting (sarcopenia, Duchenne muscular dystrophy).",
    },
    {
      type: "heading",
      text: "5. Ipamorelin",
    ...
    {
      type: "paragraph",
      text: "All five peptides require rigorous quality verification before use in any research protocol.",
    },
    {
      type: "list",
      items: [
