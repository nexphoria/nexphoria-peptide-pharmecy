...
export const article: BlogArticle = {
  slug: "nad-plus-longevity-sirtuins-parp-research-jun23-ovn16",
  title: "NAD+: Why Longevity Researchers Are Paying Attention",
  description:
    "NAD+ sits at the convergence of energy metabolism, DNA repair, and epigenetic regulation. A research-focused overview of sirtuins, PARP biology, NAD+ decline with age, and the NMN vs. NR precursor debate.",
  ...
  body: [
    ...
    {
      type: "callout",
      text: "The competition hypothesis: accumulated DNA damage → PARP hyperactivation → NAD+ depletion → sirtuin suppression → accelerated aging hallmarks. This mechanistic chain links genomic instability, epigenetic alterations, and cellular senescence in a unified framework.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "NR is a precursor to NMN, then NAD+. It was the first to enter human trials, with multiple published RCTs documenting blood NAD+ elevation (Trammell et al., Nature Communications, 2016). Studied at doses of 250–1000 mg/day in human trials, it has the most robust current human clinical evidence base.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor and highly bioavailable. However, high doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity applications that makes it less favored in aging-focused research protocols.",
    },
    {
      type: "table",
      headers: ["Precursor", "Route to NAD+", "Human Data", "Key Consideration"],
      rows: [
        ["NMN", "Direct via NMNAT", "Phase II trials ongoing", "Most direct route; growing evidence"],
        ["NR", "Via NMN then NMNAT", "Multiple published RCTs", "Best current human clinical dataset"],
        ["NAM", "Via NAMPT", "Widely studied", "High doses may inhibit sirtuins"],
      ],
    },
    {
      type: "heading",
    ...
    {
      type: "disclaimer",
      text: "This content is intended for qualified researchers only. NAD+ precursor compounds are sold exclusively for in vitro and pre-clinical research use. They are not approved for human therapeutic application or clinical use.",
    },
  ],
};
