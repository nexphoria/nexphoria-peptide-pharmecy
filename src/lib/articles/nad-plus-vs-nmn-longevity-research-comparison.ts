...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape suggests NMN benefits from a more direct pathway and emerging human data supporting systemic NAD+ elevation, with interest in combining NMN with resveratrol or pterostilbene as SIRT1 activators (though evidence for synergy remains preliminary). NR has a more extensive human clinical trial base with published safety and tolerability data across multiple studies.",
    },
    {
      type: "paragraph",
      text: "Notable research directions include tissue-specific delivery — some researchers are investigating whether different precursors preferentially elevate NAD+ in different tissues (e.g., liver vs. muscle vs. brain). NAMPT activators — compounds that upregulate the enzyme limiting NAD+ biosynthesis from nicotinamide — may offer more efficient NAD+ restoration than precursor loading. CD38 inhibitors are also under study: CD38 is a major NAD+-consuming enzyme, and reducing its activity may be as effective as increasing NAD+ supply.",
    },
    {
      type: "heading",
