...
export const article: BlogArticle = {
  slug: "longevity-peptide-stack-hallmarks-multi-target-2026",
  title: "The 2026 Longevity Peptide Stack Researchers Are Studying",
  description:
    "A research-oriented overview of the peptide combinations longevity scientists are investigating in 2026. Covers GH axis restoration, telomere biology, tissue repair, and mitochondrial targets within the hallmarks-of-aging framework.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Russia's two most studied nootropic peptides represent CNS-focused longevity components. Semax (ACTH 4-7 analog) promotes BDNF upregulation, neuroprotection, and cognitive enhancement. Selank (a tuftsin analog) provides anxiolytic effects, BDNF upregulation, and immune modulation. In longevity research, neurological aging — including cognitive decline, neuroinflammation, and HPA axis dysregulation — is an understudied target relative to metabolic and cardiovascular aging.",
    },
    {
      type: "heading",
