...
export const article: BlogArticle = {
  slug: "nad-plus-vs-nmn-longevity-researchers-guide",
  ...
  body: [
    ...
    },
    {
      ...
      items: [
        ...
        "More direct precursor pathway than NR",
    ...
    {
      type: "paragraph",
      text: "Oral NAD+ faces a significant bioavailability problem. Research suggests most ingested NAD+ is cleaved in the gut to nicotinamide before absorption. IV NAD+ infusion bypasses this limitation and is used in clinical research contexts, studying effects on neurological function, addiction recovery applications, and acute elevation of tissue NAD+ levels. Subcutaneous and intranasal NAD+ delivery are also under investigation, with some pre-clinical data suggesting improved bioavailability over oral routes.",
    },
    {
      type: "heading",
    ...
    },
    {
      type: "list",
      items: [
        "NAD+ (oral): Direct pathway but largely degraded — poor human bioavailability, limited clinical data",
        "NAD+ (IV/SC): Direct delivery, high bioavailability — emerging human data",
        "NMN: 1 step via NMNAT — moderate-to-good bioavailability, growing clinical dataset",
        "NR: 2 steps via NRK then NMNAT — good bioavailability, established clinical data",
        "Nicotinamide (NAM): Salvage pathway — good bioavailability but feedback inhibition concern",
      ],
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "The longevity research community has not converged on a single preferred compound. The current evidence landscape offers arguments for both leading approaches.",
    },
    {
      type: "subheading",
