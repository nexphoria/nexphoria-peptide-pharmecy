...
export const article: BlogArticle = {
  slug: "five-peptides-muscle-recovery-research-jun23-ovn-final",
  title: "5 Research Peptides Used in Muscle Recovery Studies",
  description:
    "BPC-157, TB-500, IGF-1 LR3, Follistatin-344, and Ipamorelin have been examined in preclinical muscle recovery and regeneration studies. This article summarizes the mechanistic evidence for each compound.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "BPC-157 is thought to act via nitric oxide modulation and FAK-paxillin signaling, enhancing cell migration and angiogenesis critical to repair. Key references include work by Sikiric et al. (University of Zagreb) and the Gwyer et al. systematic review (2019).",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "By binding myostatin with high affinity, follistatin prevents myostatin from activating its receptor (ActRIIB), thereby disinhibiting muscle growth pathways including Akt/mTOR and satellite cell activation. Follistatin-344 research has clinical relevance to conditions involving muscle wasting such as sarcopenia and Duchenne muscular dystrophy.",
    },
    {
      type: "heading",
      text: "5. Ipamorelin",
    ...
    {
      type: "paragraph",
      text: "All five peptides require rigorous quality verification for research use. Minimum standards include HPLC purity ≥99% with chromatogram provided, mass spectrometry identity confirmation (ESI-MS or MALDI-TOF), endotoxin-free certification via LAL testing (<1 EU/mg), and cold-chain shipping and storage protocols. A supplier capable of providing batch-specific certificates of analysis meeting these criteria for all five compounds reduces sourcing risk in multi-compound research protocols.",
    },
    {
      type: "heading",
      text: "Summary",
