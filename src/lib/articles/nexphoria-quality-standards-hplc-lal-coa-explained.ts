...
export const article: BlogArticle = {
  slug: "nexphoria-quality-standards-hplc-lal-coa-explained",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A Certificate of Analysis is the primary quality document for a research compound. At Nexphoria, every COA includes the following:",
    },
    {
      type: "table",
    ...
    {
      type: "paragraph",
      text: "Quality testing can only validate what synthesis quality delivers. Nexphoria sources from synthesis partners that maintain GMP-aligned synthesis protocols with controlled environment and documented procedures, Solid-Phase Peptide Synthesis (SPPS) with validated coupling efficiency, intermediate purification to minimize side-chain modification products, and final purification by preparative HPLC to achieve target purity before testing.",
    },
    {
      type: "heading",
