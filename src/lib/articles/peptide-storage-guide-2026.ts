...
export const article: BlogArticle = {
  slug: "peptide-storage-guide-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Most peptides are sensitive to UV light. Vials should be stored in original amber or opaque vials, in dark storage areas, and away from laboratory UV lamps. Peptides containing tryptophan (Trp/W) residues are particularly photosensitive — this includes GHRP-2, GHRP-6, and Hexarelin. Extra light protection is warranted for these compounds.",
    },
    {
      type: "heading",
