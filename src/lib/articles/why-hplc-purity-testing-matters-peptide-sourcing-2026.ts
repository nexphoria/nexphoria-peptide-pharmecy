...
export const article: BlogArticle = {
  ...
  description:
    "HPLC purity testing is the gold standard for research peptides — what the method measures, why ≥99% purity matters for experimental validity, and how it compares to mass spectrometry and LAL endotoxin testing.",
  ...
  body: [
    ...
    {
      type: "callout",
      text: "Consider a 10 mg/mL peptide solution at 95% HPLC purity. That preparation contains 0.5 mg/mL of unknown impurities — potentially including biologically active fragments with different receptor binding profiles. The 99% threshold exists specifically to reduce this variability to a level unlikely to materially affect experimental outcomes.",
    },
    {
      type: "heading",
