...
export const article: BlogArticle = {
  slug: "why-hplc-purity-testing-matters-peptide-sourcing-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "When reviewing a certificate of analysis, look for the following:",
    },
    {
      type: "table",
