...
export const article: BlogArticle = {
  slug: "peptide-sciences-alternative-research-guide-jun20-2026",
  ...
  body: [
    ...
    },
    {
      ...
      items: [
        ...
        "LAL (Limulus Amebocyte Lysate) endotoxin testing — ensuring products are free of bacterial endotoxins",
