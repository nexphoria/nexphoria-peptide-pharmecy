...
export const article: BlogArticle = {
  slug: "nexphoria-quality-standards-research-peptides",
  ...
  body: [
    ...
    {
      type: "callout",
      text: "Nexphoria Standard: Every Nexphoria product is tested at ≥98% HPLC purity. The chromatogram for each specific batch is included in the batch COA — not an average or a representative example from a prior lot.",
    },
    {
      type: "paragraph",
    ...
    {
      type: "callout",
      text: "Nexphoria Standard: Every Nexphoria product includes mass spectrometry data confirming sequence identity. Theoretical and observed MW are reported in the COA, with acceptable tolerance of ±0.5 Da for standard synthetic peptides.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "In research contexts, endotoxin-contaminated compounds will activate NF-κB and pro-inflammatory cytokine cascades in any cell expressing TLR4, confound cytokine measurements and gene expression studies, and produce spurious animal model results attributed to the compound under study.",
    },
    {
      type: "paragraph",
      text: "The Limulus Amebocyte Lysate (LAL) test uses clotting enzymes from horseshoe crab blood cells that react specifically with LPS. The quantitative LAL assay (rFC or traditional LAL) provides a numerical endotoxin value in EU/mg or EU/mL.",
    },
    {
      type: "callout",
      text: "Nexphoria Standard: All Nexphoria products are tested for endotoxin using the LAL method. Results are reported in the COA with a pass/fail determination against the applicable limit for the research application.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "A Certificate of Analysis is the primary quality document for a research compound. Every Nexphoria COA includes the following fields for each specific batch:",
    },
    {
      type: "table",
