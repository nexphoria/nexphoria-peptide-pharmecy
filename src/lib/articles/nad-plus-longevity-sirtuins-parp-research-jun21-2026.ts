...
export const article: BlogArticle = {
  slug: "nad-plus-longevity-sirtuins-parp-research-jun21-2026",
  title: "NAD+: Why Longevity Researchers Are Paying Attention",
  description:
    "NAD+ is central to longevity research — sirtuins, PARP repair, and the hallmarks of aging. An evidence-based overview of why NAD+ declines with age, how it connects to sirtuin and PARP biology, and how precursors NMN, NR, and NAM compare in current literature.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The drivers of this decline appear to be multifactorial: decreased biosynthesis via the salvage pathway (NAMPT activity declines), increased consumption by PARP enzymes in response to cumulative DNA damage, and elevated CD38 expression in aged tissues, which degrades NAD+.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "NR is a precursor to NMN, then NAD+, and was the first NAD+ precursor to enter human trials. Multiple published RCTs document blood NAD+ elevation (Trammell et al., Nature Communications, 2016). It is commercially available and has been studied at doses of 250–1000 mg/day in human trials.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "NAM is the simplest precursor and is highly bioavailable. However, high doses can inhibit sirtuins by product feedback inhibition — a potential limitation for longevity applications where sirtuin activation is the goal.",
    },
    {
      type: "callout",
