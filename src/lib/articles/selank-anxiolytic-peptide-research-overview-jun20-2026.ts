...
export const article: BlogArticle = {
  slug: "selank-anxiolytic-peptide-research-overview-jun20-2026",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Beyond anxiolytic activity, Selank has been studied for cognitive enhancement properties. Animal studies report improved performance on learning and memory tasks; clinical observations in Russian studies describe reduced cognitive fatigue without stimulant-like effects; and some research documents protection against oxidative stress-induced neuronal damage in cell culture models.",
    },
    {
      type: "heading",
    ...
    },
    {
      type: "list",
      items: [
        "Store lyophilized form; reconstituted solutions at 2–8°C, use within 2–4 weeks",
        "Sensitive to enzymatic degradation at elevated temperatures",
        "HPLC ≥98% purity and mass spectrometry identity verification should be confirmed in COA documentation",
