...
export const article: BlogArticle = {
  slug: "peptide-reconstitution-guide-2026",
  title: "How to Reconstitute Peptides: A Research Protocol Guide",
  description: "Step-by-step research protocol for reconstituting lyophilized peptides. Covers bacteriostatic water, acetic acid, dilution math, and storage best practices.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Plain sterile water (no preservative) is appropriate when the entire vial will be used in a single application, or when the peptide is incompatible with benzyl alcohol — which is rare but documented for some sequences.",
    },
    {
      type: "subheading",
    ...
    {
      type: "paragraph",
      text: "Some peptides, particularly hydrophobic sequences or those with poor aqueous solubility, require an acidic diluent for initial dissolution. IGF-1 and some variants of GH-releasing peptides may dissolve more completely in dilute acetic acid. The standard protocol: dissolve initially in acetic acid, then dilute to final concentration with bacteriostatic water or phosphate-buffered saline (PBS).",
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      items: [
        ...
        "Minimize freeze-thaw cycles — each cycle degrades peptide integrity. Pre-aliquot if long-term storage is needed.",
