...
export const article: BlogArticle = {
  ...
  description:
    "Semaglutide as a research peptide — what published studies show on GLP-1 receptor agonism, metabolic regulation, obesity models, cardiovascular outcomes, and CNS effects. An evidence-based overview.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The most widely cited human clinical research on semaglutide is the STEP (Semaglutide Treatment Effect in People with Obesity) trial program, published in The New England Journal of Medicine. STEP 1 (Wilding et al., 2021) — a 68-week double-blind RCT — showed participants receiving semaglutide 2.4 mg weekly achieved mean body weight reduction of 14.9% versus 2.4% in the placebo group. STEP 3 (Wadden et al., 2021) combined semaglutide with intensive behavioral intervention, yielding average weight reduction of 16%. STEP 4 (Rubino et al., 2021) was a withdrawal study demonstrating weight regain upon cessation, confirming metabolic effects are pharmacodynamically sustained only during active treatment.",
    },
    {
      type: "subheading",
    ...
    {
      type: "callout",
      text: "Key sourcing requirements: sequence verification via mass spectrometry is essential (semaglutide's modified backbone requires confirmation of the C18 fatty acid chain integrity), HPLC purity ≥99% should be verified from a COA, endotoxin testing (LAL) is required for in vivo administration protocols, and proper cold-chain storage (2–8°C) is critical for maintaining biological activity.",
    },
    {
      type: "heading",
