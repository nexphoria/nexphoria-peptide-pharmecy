...
export const article: BlogArticle = {
  slug: "semaglutide-research-peptide-glp1-studies-guide",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Semaglutide binds with high affinity to the GLP-1 receptor (GLP-1R), a G-protein coupled receptor (GPCR) expressed throughout the body: in the pancreas (insulin secretion, beta-cell preservation), hypothalamus (satiety signaling), liver (suppression of hepatic glucose output), GI tract (slowed gastric emptying), and the cardiovascular system where anti-inflammatory and cardioprotective effects are under study.",
    },
    {
      type: "paragraph",
    ...
    },
    {
      ...
      items: [
        ...
        "STEP 4 (Rubino et al., 2021) — Withdrawal study showing weight regain upon cessation, confirming metabolic effects are pharmacodynamically sustained only during active treatment.",
      ],
    },
    {
      type: "heading",
