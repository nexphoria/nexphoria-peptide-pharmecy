...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "The tetrapeptide Epithalon (Ala-Glu-Asp-Gly) has been studied since the 1980s for telomerase activation and longevity extension in multiple model organisms. It represents the most investigated peptide tool for direct telomere biology research. The research base primarily originates from the St. Petersburg Institute of Bioregulation and Gerontology, and independent replication remains limited — a caveat researchers should weigh carefully when designing protocols.",
    },
    {
      type: "callout",
    ...
    {
      type: "paragraph",
      text: "Age-dependent decline in MOTS-c levels suggests it as both a biomarker and potential intervention target. Human studies are nascent, and extrapolation from preclinical data requires caution.",
    },
    {
      type: "callout",
    ...
    {
      type: "paragraph",
      text: "Russia's two most studied nootropic peptides represent CNS-focused longevity components. Semax (ACTH 4-7 analog) has been studied for BDNF upregulation, neuroprotection, and cognitive enhancement. Selank (tuftsin analog) has been examined for anxiolytic effects, BDNF upregulation, and immune modulation.",
    },
    {
      type: "paragraph",
