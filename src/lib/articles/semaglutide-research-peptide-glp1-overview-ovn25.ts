...
export const article: BlogArticle = {
  slug: "semaglutide-research-peptide-glp1-overview-ovn25",
  title: "Semaglutide as a Research Peptide: What the Studies Show",
  description:
    "An evidence-based overview of semaglutide as a GLP-1 receptor agonist in research: mechanism of action, STEP trial findings, preclinical obesity models, cardiovascular outcomes, and what researchers need to know when working with this compound.",
