...
export const article: BlogArticle = {
  slug: "nexphoria-quality-standards-hplc-lal-coa-jun21-2026",
  title: "Nexphoria Quality Standards: HPLC, LAL Testing, and COA Transparency",
  description:
    "How Nexphoria verifies research peptide quality — batch-specific HPLC purity analysis, LAL endotoxin testing, mass spectrometry identity confirmation, and full COA documentation. Why each test matters and what to look for when evaluating supplier quality claims.",
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "A Certificate of Analysis is the primary quality document for a research compound. At Nexphoria, every COA includes compound name (full IUPAC name and common name), amino acid sequence, batch/lot number for traceability, HPLC purity percentage with chromatogram, MS data with theoretical and observed MW, LAL endotoxin result (EU/mg value and pass/fail), testing laboratory name and accreditation, testing date for this specific batch, and recommended storage conditions.",
    },
    {
      type: "callout",
    ...
    {
      type: "paragraph",
      text: "Quality at synthesis is only preserved if the cold chain is maintained through shipping and delivery. Nexphoria ships lyophilized products with cold packs for temperature-sensitive routes, uses amber/opaque vials to protect photosensitive compounds, provides sealed secondary packaging with moisture-control desiccant, and includes temperature indicators on shipments where required.",
    },
    {
      type: "heading",
