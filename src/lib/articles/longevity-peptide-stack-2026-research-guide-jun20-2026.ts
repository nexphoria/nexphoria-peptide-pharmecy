...
export const article: BlogArticle = {
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Humanin is another MDP with documented roles in neuroprotection (originally identified in Alzheimer's disease context), cardiovascular protection, and metabolic regulation. Humanin and MOTS-c are increasingly studied together as a mitochondria-derived peptide combination targeting multiple aspects of mitochondrial decline.",
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      items: [
        ...
        "Endotoxin/inflammatory load → Compound purity verification (LAL testing)",
      ],
    },
    {
      type: "heading",
