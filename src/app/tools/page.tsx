...
const TOOLS = [
  ...
  },
  {
    ...
    title: "Vial Inventory Tracker",
    desc: "Track your research vials, monitor expiry dates, and manage your peptide inventory. Add vials, set expiry alerts, mark as used, and export to CSV. All data stored locally in your browser.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
