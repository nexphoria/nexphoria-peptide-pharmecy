    ...
    <div className="min-h-screen" style={{ backgroundColor: "#EAE7E3", paddingTop: "120px" }}>
      <div className="max-w-md mx-auto px-6">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl mb-2" style={{ fontWeight: 200, color: "#010101" }}>Create Account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="confirm" className="block text-xs uppercase mb-2" style={{ color: "#7F7F7D", letterSpacing: "0.1em" }}>
              Confirm Password
            </label>
            <input
              type="password"
        ...
        <p className="text-center text-xs mt-8" style={{ color: "#7F7F7D" }}>
